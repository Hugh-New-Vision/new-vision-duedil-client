...
/**
 * CreditReportApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class CreditReportApi
{
    ...
    /**
     * Operation companyCountryCodeCompanyIdCreditReportFormatGet
     *
     * Credit report
     *
     ...
     * @return \Swagger\Client\Model\CompanyCreditReportResponse
     */
    public function companyCountryCodeCompanyIdCreditReportFormatGet($country_code, $company_id, $format)
    {
        list($response) = $this->companyCountryCodeCompanyIdCreditReportFormatGetWithHttpInfo($country_code, $company_id, $format);
        return $response;
    }

    /**
     * Operation companyCountryCodeCompanyIdCreditReportFormatGetWithHttpInfo
     *
     * Credit report
     *
     * @param  string $country_code [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code in lowercase. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CompanyCreditReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function companyCountryCodeCompanyIdCreditReportFormatGetWithHttpInfo($country_code, $company_id, $format)
    {
        $returnType = '\Swagger\Client\Model\CompanyCreditReportResponse';
        $request = $this->companyCountryCodeCompanyIdCreditReportFormatGetRequest($country_code, $company_id, $format);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CompanyCreditReportResponse',
    ...
    /**
     * Operation companyCountryCodeCompanyIdCreditReportFormatGetAsync
     *
     * Credit report
     *
     * @param  string $country_code [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code in lowercase. (required)
     ...
     */
    public function companyCountryCodeCompanyIdCreditReportFormatGetAsync($country_code, $company_id, $format)
    {
        return $this->companyCountryCodeCompanyIdCreditReportFormatGetAsyncWithHttpInfo($country_code, $company_id, $format)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyCountryCodeCompanyIdCreditReportFormatGetAsyncWithHttpInfo
     *
     * Credit report
     *
     * @param  string $country_code [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code in lowercase. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyCountryCodeCompanyIdCreditReportFormatGetAsyncWithHttpInfo($country_code, $company_id, $format)
    {
        $returnType = '\Swagger\Client\Model\CompanyCreditReportResponse';
        $request = $this->companyCountryCodeCompanyIdCreditReportFormatGetRequest($country_code, $company_id, $format);
    ...
    /**
     * Create request for operation 'companyCountryCodeCompanyIdCreditReportFormatGet'
     *
     * @param  string $country_code [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code in lowercase. (required)
     * @param  string $company_id Company registration number (required)
     * @param  string $format Response format. Currently, only supported option is json. (required)
     ...
     */
    protected function companyCountryCodeCompanyIdCreditReportFormatGetRequest($country_code, $company_id, $format)
    {
        // verify the required parameter 'country_code' is set
        if ($country_code === null || (is_array($country_code) && count($country_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country_code when calling companyCountryCodeCompanyIdCreditReportFormatGet'
            );
        }
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_id when calling companyCountryCodeCompanyIdCreditReportFormatGet'
            );
        }
        // verify the required parameter 'format' is set
        if ($format === null || (is_array($format) && count($format) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $format when calling companyCountryCodeCompanyIdCreditReportFormatGet'
            );
        }

        $resourcePath = '/company/{countryCode}/{companyId}/credit-report.{format}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
