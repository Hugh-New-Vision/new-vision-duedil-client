<?php
/**
 * CompanySearchResultsFiltersIncorporated
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchResultsFiltersIncorporated Class Doc Comment
 *
 * @category Class
 * @description Optional incorporation date range issued in the search request
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchResultsFiltersIncorporated implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanySearchResults_filters_incorporated';
