...
/**
 * RegionSearchResultsFilters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegionSearchResultsFilters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionSearchResults_filters';
     ...
     * Sets name
     *
     * @param string $name Region name partial issued in the search request
     *
     * @return $this
     */
