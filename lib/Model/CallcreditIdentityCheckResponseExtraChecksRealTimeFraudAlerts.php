...
/**
 * CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_realTimeFraudAlerts';
    ...
    protected static $swaggerTypes = [
        'warnings' => 'string[]',
        'report' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport'
    ];
     ...
     * Sets warnings
     *
     * @param string[] $warnings Any relevant warnings related to the RTFA report. For example if the user has no access to this module the report will be NULL and that will be explained in a warning message.
     *
     * @return $this
     */
     ...
     * Gets report
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport
     */
     ...
     * Sets report
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport $report report
     *
     * @return $this
     */
