<?php
/**
 * CompanyCheckResultsMatchedCompanyDocumentFilingCounts
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyDocumentFilingCounts Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyDocumentFilingCounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_documentFilingCounts';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['incorporation'] = isset($data['incorporation']) ? $data['incorporation'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['incorporation'] === null) {
            $invalidProperties[] = "'incorporation' can't be null";
        }
        if ($this->container['capital'] === null) {
            $invalidProperties[] = "'capital' can't be null";
        }
        if ($this->container['miscellaneous'] === null) {
            $invalidProperties[] = "'miscellaneous' can't be null";
        }
     ...
     * Sets annual_returns
     *
     * @param int $annual_returns annual_returns
     *
     * @return $this
     */
     ...
     * Sets appointments
     *
     * @param int $appointments appointments
     *
     * @return $this
     */
     ...
     *
     * @param int $registered_address registered_address
     *
     * @return $this
     */
     ...
     * Sets incorporation
     *
     * @param int $incorporation incorporation
     *
     * @return $this
     */
     ...
     * Sets miscellaneous
     *
     * @param int $miscellaneous miscellaneous
     *
     * @return $this
     */
