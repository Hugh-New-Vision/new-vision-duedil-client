...
/**
 * RegionSearchResultsRegions Class Doc Comment
 *
 * @category Class
 * @description Region information that satisfies the search criteria
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegionSearchResultsRegions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionSearchResults_regions';
     ...
     * Sets region_id
     *
     * @param string $region_id Region ID to be used in company or officer search filters
     *
     * @return $this
     */
     ...
     * Sets area
     *
     * @param float $area Region area in kilometres
     *
     * @return $this
     */
