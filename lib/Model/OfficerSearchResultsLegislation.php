<?php
/**
 * OfficerSearchResultsLegislation
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OfficerSearchResultsLegislation Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OfficerSearchResultsLegislation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OfficerSearchResults_legislation';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['act'] === null) {
            $invalidProperties[] = "'act' can't be null";
        }
     ...
     * Sets act
     *
     * @param string $act Legislation act reference for the related disqualification
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Legislation act brief description
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Legislation act link with further details
     *
     * @return $this
     */
