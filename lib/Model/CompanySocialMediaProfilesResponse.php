<?php
/**
 * CompanySocialMediaProfilesResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySocialMediaProfilesResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanySocialMediaProfilesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanySocialMediaProfilesResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'social_media_profiles' => '\Swagger\Client\Model\SocialMediaProfilesSocialMediaProfiles[]'
    ];
    ...
    protected static $setters = [
        ...
        'social_media_profiles' => 'setSocialMediaProfiles'
    ];
    ...
    protected static $getters = [
        ...
        'social_media_profiles' => 'getSocialMediaProfiles'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['social_media_profiles'] = isset($data['social_media_profiles']) ? $data['social_media_profiles'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['social_media_profiles'] === null) {
            $invalidProperties[] = "'social_media_profiles' can't be null";
        }
    ...
    /**
     * Gets social_media_profiles
     *
     * @return \Swagger\Client\Model\SocialMediaProfilesSocialMediaProfiles[]
     */
    public function getSocialMediaProfiles()
    {
        return $this->container['social_media_profiles'];
    }

    /**
     * Sets social_media_profiles
     *
     * @param \Swagger\Client\Model\SocialMediaProfilesSocialMediaProfiles[] $social_media_profiles social_media_profiles
     *
     * @return $this
     */
    public function setSocialMediaProfiles($social_media_profiles)
    {
        $this->container['social_media_profiles'] = $social_media_profiles;
