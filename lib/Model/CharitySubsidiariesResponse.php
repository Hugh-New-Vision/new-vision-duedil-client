...
/**
 * CharitySubsidiariesResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CharitySubsidiariesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CharitySubsidiariesResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subsidiaries'] = isset($data['subsidiaries']) ? $data['subsidiaries'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subsidiaries'] === null) {
            $invalidProperties[] = "'subsidiaries' can't be null";
        }
     ...
     * Sets subsidiaries
     *
     * @param object[] $subsidiaries subsidiaries
     *
     * @return $this
     */
