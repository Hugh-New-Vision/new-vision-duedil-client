<?php
/**
 * CompanyCheckResultsMatchedCompanyAppointments
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyAppointments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyAppointments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_appointments';
    ...
    protected static $swaggerTypes = [
        ...
        'service_address' => '\Swagger\Client\Model\CompanyCheckResultsMatchedCompanyServiceAddress'
    ];
    ...
    protected static $attributeMap = [
        ...
        'self_described_position' => 'selfDescribedPosition',
    ...
    protected static $setters = [
        ...
        'end_date' => 'setEndDate',
        'official_role' => 'setOfficialRole',
        'self_described_position' => 'setSelfDescribedPosition',
    ...
    protected static $getters = [
        ...
        'end_date' => 'getEndDate',
        'official_role' => 'getOfficialRole',
        'self_described_position' => 'getSelfDescribedPosition',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['official_role'] = isset($data['official_role']) ? $data['official_role'] : null;
        $this->container['self_described_position'] = isset($data['self_described_position']) ? $data['self_described_position'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['official_role'] === null) {
            $invalidProperties[] = "'official_role' can't be null";
        }
        if ($this->container['self_described_position'] === null) {
            $invalidProperties[] = "'self_described_position' can't be null";
        }
     ...
     * @return string
     */
    public function getOfficialRole()
    {
        return $this->container['official_role'];
    }

    /**
     * Sets official_role
     *
     * @param string $official_role official_role
     *
     * @return $this
     */
    public function setOfficialRole($official_role)
    {
        $this->container['official_role'] = $official_role;

        return $this;
    }

    /**
     * Gets self_described_position
     *
     * @return string
     */
    public function getSelfDescribedPosition()
    {
        return $this->container['self_described_position'];
    }

    /**
     * Sets self_described_position
     *
     * @param string $self_described_position self_described_position
     *
     * @return $this
     */
    public function setSelfDescribedPosition($self_described_position)
    {
        $this->container['self_described_position'] = $self_described_position;
     ...
     *
     * @return \Swagger\Client\Model\CompanyCheckResultsMatchedCompanyServiceAddress
     */
     ...
     *
     * @param \Swagger\Client\Model\CompanyCheckResultsMatchedCompanyServiceAddress $service_address service_address
     *
     * @return $this
     */
