...
/**
 * RegionSearchCriteriaCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegionSearchCriteriaCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionSearchCriteria_criteria';
     ...
     * Sets name
     *
     * @param string $name Name (or partial) of the desired region
     *
     * @return $this
     */
