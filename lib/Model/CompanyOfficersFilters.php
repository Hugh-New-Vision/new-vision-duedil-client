...
/**
 * CompanyOfficersFilters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyOfficersFilters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyOfficers_filters';
    ...
    const APPOINTMENT_STATUSES_OPEN = 'open';
    const APPOINTMENT_STATUSES_CLOSED = 'closed';
    const APPOINTMENT_STATUSES_RETIRED = 'retired';
     ...
     * @return string[]
     */
    public function getAppointmentStatusesAllowableValues()
    {
        return [
            self::APPOINTMENT_STATUSES_OPEN,
            self::APPOINTMENT_STATUSES_CLOSED,
            self::APPOINTMENT_STATUSES_RETIRED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['appointment_statuses'] === null) {
            $invalidProperties[] = "'appointment_statuses' can't be null";
        }
     ...
     *
     * @param string[] $appointment_statuses appointment_statuses
     *
     * @return $this
     */
    public function setAppointmentStatuses($appointment_statuses)
    {
        $allowedValues = $this->getAppointmentStatusesAllowableValues();
        if (array_diff($appointment_statuses, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'appointment_statuses', must be one of '%s'",
