...
/**
 * CallcreditExtraChecksInputExtraChecks Class Doc Comment
 *
 * @category Class
 * @description [OPTIONAL] Flags to define any extra checks that need to be requested for the given report.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditExtraChecksInputExtraChecks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditExtraChecksInput_extraChecks';
    ...
    protected static $swaggerTypes = [
        'email_risk' => 'bool',
        'real_time_fraud_alerts' => 'bool',
        'watchlist_screening' => 'bool'
    ];
    ...
    {
        $this->container['email_risk'] = isset($data['email_risk']) ? $data['email_risk'] : false;
        $this->container['real_time_fraud_alerts'] = isset($data['real_time_fraud_alerts']) ? $data['real_time_fraud_alerts'] : false;
        $this->container['watchlist_screening'] = isset($data['watchlist_screening']) ? $data['watchlist_screening'] : false;
    }
     ...
     * Sets email_risk
     *
     * @param bool $email_risk Request Email risk report
     *
     * @return $this
     */
     ...
     *
     * @param bool $real_time_fraud_alerts Request Real time fraud alert report
     *
     * @return $this
     */
     ...
     *
     * @param bool $watchlist_screening Request information on potential matches to various watchlists
     *
     * @return $this
     */
