...
/**
 * CallcreditIdentityCheckResponseCountyCourtJudgments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseCountyCourtJudgments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_countyCourtJudgments';
    ...
    protected static $attributeMap = [
        'ccj_count' => 'ccjCount',
        'ccj_level_of_confidence' => 'ccjLevelOfConfidence'
    ];
    ...
    protected static $setters = [
        'ccj_count' => 'setCcjCount',
        'ccj_level_of_confidence' => 'setCcjLevelOfConfidence'
    ];
    ...
    protected static $getters = [
        'ccj_count' => 'getCcjCount',
        'ccj_level_of_confidence' => 'getCcjLevelOfConfidence'
    ];
    ...
    {
        $this->container['ccj_count'] = isset($data['ccj_count']) ? $data['ccj_count'] : null;
        $this->container['ccj_level_of_confidence'] = isset($data['ccj_level_of_confidence']) ? $data['ccj_level_of_confidence'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ccj_count'] === null) {
            $invalidProperties[] = "'ccj_count' can't be null";
        }
        if ($this->container['ccj_level_of_confidence'] === null) {
            $invalidProperties[] = "'ccj_level_of_confidence' can't be null";
        }
     ...
     * @return int
     */
    public function getCcjCount()
    {
        return $this->container['ccj_count'];
    }

    /**
     * Sets ccj_count
     *
     * @param int $ccj_count Number of County Court Judgments (CCJs) listed against the individual
     *
     * @return $this
     */
    public function setCcjCount($ccj_count)
    {
        $this->container['ccj_count'] = $ccj_count;

        return $this;
    }

    /**
     * Gets ccj_level_of_confidence
     *
     * @return int
     */
    public function getCcjLevelOfConfidence()
    {
        return $this->container['ccj_level_of_confidence'];
    }

    /**
     * Sets ccj_level_of_confidence
     *
     * @param int $ccj_level_of_confidence ccj_level_of_confidence
     *
     * @return $this
     */
    public function setCcjLevelOfConfidence($ccj_level_of_confidence)
    {
        $this->container['ccj_level_of_confidence'] = $ccj_level_of_confidence;
