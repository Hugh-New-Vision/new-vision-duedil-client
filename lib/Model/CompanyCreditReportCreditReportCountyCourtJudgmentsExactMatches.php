<?php
/**
 * CompanyCreditReportCreditReportCountyCourtJudgmentsExactMatches
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCreditReportCreditReportCountyCourtJudgmentsExactMatches Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCreditReportCreditReportCountyCourtJudgmentsExactMatches implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCreditReport_creditReport_countyCourtJudgments_exactMatches';
    ...
    protected static $swaggerTypes = [
        ...
        'date' => '\DateTime',
        'court' => 'string',
        'amount' => '\Swagger\Client\Model\CompanyCreditReportCreditReportCountyCourtJudgmentsAmount',
        'status' => 'string',
    ...
    protected static $setters = [
        ...
        'amount' => 'setAmount',
        'status' => 'setStatus',
        'satisfied_date' => 'setSatisfiedDate',
        'address' => 'setAddress'
    ];
    ...
    protected static $getters = [
        ...
        'amount' => 'getAmount',
        'status' => 'getStatus',
        'satisfied_date' => 'getSatisfiedDate',
        'address' => 'getAddress'
    ];
    ...
    const STATUS_ACTIVE_JUDGMENT = 'Active judgment';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['satisfied_date'] = isset($data['satisfied_date']) ? $data['satisfied_date'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['court'] === null) {
            $invalidProperties[] = "'court' can't be null";
        }
        ...
        if ($this->container['satisfied_date'] === null) {
            $invalidProperties[] = "'satisfied_date' can't be null";
        }
     ...
     * Gets amount
     *
     * @return \Swagger\Client\Model\CompanyCreditReportCreditReportCountyCourtJudgmentsAmount
     */
     ...
     * Sets amount
     *
     * @param \Swagger\Client\Model\CompanyCreditReportCreditReportCountyCourtJudgmentsAmount $amount amount
     *
     * @return $this
     */
     ...
     * @return \DateTime
     */
    public function getSatisfiedDate()
    {
        return $this->container['satisfied_date'];
    }

    /**
     * Sets satisfied_date
     *
     * @param \DateTime $satisfied_date satisfied_date
     *
     * @return $this
     */
    public function setSatisfiedDate($satisfied_date)
    {
        $this->container['satisfied_date'] = $satisfied_date;
