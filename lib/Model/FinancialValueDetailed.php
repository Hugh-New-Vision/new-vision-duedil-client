...
/**
 * FinancialValueDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FinancialValueDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FinancialValueDetailed';
    ...
    protected static $attributeMap = [
        ...
        'three_year_cagr' => 'threeYearCAGR',
        'five_year_cagr' => 'fiveYearCAGR',
        'ten_year_cagr' => 'tenYearCAGR'
    ];
    ...
    protected static $setters = [
        'value' => 'setValue',
        'delta_absolute' => 'setDeltaAbsolute',
        'delta_percentage' => 'setDeltaPercentage',
        'three_year_cagr' => 'setThreeYearCagr',
        'five_year_cagr' => 'setFiveYearCagr',
        'ten_year_cagr' => 'setTenYearCagr'
    ];
    ...
    protected static $getters = [
        'value' => 'getValue',
        'delta_absolute' => 'getDeltaAbsolute',
        'delta_percentage' => 'getDeltaPercentage',
        'three_year_cagr' => 'getThreeYearCagr',
        'five_year_cagr' => 'getFiveYearCagr',
        'ten_year_cagr' => 'getTenYearCagr'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['delta_absolute'] = isset($data['delta_absolute']) ? $data['delta_absolute'] : null;
        $this->container['delta_percentage'] = isset($data['delta_percentage']) ? $data['delta_percentage'] : null;
        $this->container['three_year_cagr'] = isset($data['three_year_cagr']) ? $data['three_year_cagr'] : null;
        $this->container['five_year_cagr'] = isset($data['five_year_cagr']) ? $data['five_year_cagr'] : null;
        $this->container['ten_year_cagr'] = isset($data['ten_year_cagr']) ? $data['ten_year_cagr'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['delta_absolute'] === null) {
            $invalidProperties[] = "'delta_absolute' can't be null";
        }
        if ($this->container['delta_percentage'] === null) {
            $invalidProperties[] = "'delta_percentage' can't be null";
        }
        if ($this->container['three_year_cagr'] === null) {
            $invalidProperties[] = "'three_year_cagr' can't be null";
        }
        if ($this->container['five_year_cagr'] === null) {
            $invalidProperties[] = "'five_year_cagr' can't be null";
        }
        if ($this->container['ten_year_cagr'] === null) {
            $invalidProperties[] = "'ten_year_cagr' can't be null";
        }
     ...
     * @return float
     */
    public function getDeltaAbsolute()
    {
        return $this->container['delta_absolute'];
    }

    /**
     * Sets delta_absolute
     *
     * @param float $delta_absolute delta_absolute
     *
     * @return $this
     */
    public function setDeltaAbsolute($delta_absolute)
    {
        $this->container['delta_absolute'] = $delta_absolute;

        return $this;
    }

    /**
     * Gets delta_percentage
     *
     * @return float
     */
    public function getDeltaPercentage()
    {
        return $this->container['delta_percentage'];
    }

    /**
     * Sets delta_percentage
     *
     * @param float $delta_percentage delta_percentage
     *
     * @return $this
     */
    public function setDeltaPercentage($delta_percentage)
    {
        $this->container['delta_percentage'] = $delta_percentage;

        return $this;
    }

    /**
     * Gets three_year_cagr
     *
     * @return float
     */
    public function getThreeYearCagr()
    {
        return $this->container['three_year_cagr'];
    }

    /**
     * Sets three_year_cagr
     *
     * @param float $three_year_cagr three_year_cagr
     *
     * @return $this
     */
    public function setThreeYearCagr($three_year_cagr)
    {
        $this->container['three_year_cagr'] = $three_year_cagr;
     ...
     * @return float
     */
    public function getFiveYearCagr()
    {
        return $this->container['five_year_cagr'];
    }

    /**
     * Sets five_year_cagr
     *
     * @param float $five_year_cagr five_year_cagr
     *
     * @return $this
     */
    public function setFiveYearCagr($five_year_cagr)
    {
        $this->container['five_year_cagr'] = $five_year_cagr;
     ...
     * @return float
     */
    public function getTenYearCagr()
    {
        return $this->container['ten_year_cagr'];
    }

    /**
     * Sets ten_year_cagr
     *
     * @param float $ten_year_cagr ten_year_cagr
     *
     * @return $this
     */
    public function setTenYearCagr($ten_year_cagr)
    {
        $this->container['ten_year_cagr'] = $ten_year_cagr;
