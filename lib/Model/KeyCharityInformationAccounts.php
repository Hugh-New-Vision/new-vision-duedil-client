...
/**
 * KeyCharityInformationAccounts Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeyCharityInformationAccounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeyCharityInformation_accounts';
    ...
    protected static $swaggerTypes = [
        'latest_accounts_start_date' => '\DateTime',
        'latest_accounts_end_date' => '\DateTime',
        'currency' => 'string',
    ...
    protected static $swaggerFormats = [
        'latest_accounts_start_date' => 'date',
        'latest_accounts_end_date' => 'date',
        'currency' => null,
    ...
    protected static $attributeMap = [
        'latest_accounts_start_date' => 'latestAccountsStartDate',
        'latest_accounts_end_date' => 'latestAccountsEndDate',
        'currency' => 'currency',
    ...
    protected static $setters = [
        'latest_accounts_start_date' => 'setLatestAccountsStartDate',
        'latest_accounts_end_date' => 'setLatestAccountsEndDate',
    ...
    protected static $getters = [
        'latest_accounts_start_date' => 'getLatestAccountsStartDate',
        'latest_accounts_end_date' => 'getLatestAccountsEndDate',
    ...
    {
        $this->container['latest_accounts_start_date'] = isset($data['latest_accounts_start_date']) ? $data['latest_accounts_start_date'] : null;
        $this->container['latest_accounts_end_date'] = isset($data['latest_accounts_end_date']) ? $data['latest_accounts_end_date'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['latest_accounts_start_date'] === null) {
            $invalidProperties[] = "'latest_accounts_start_date' can't be null";
        }
        if ($this->container['latest_accounts_end_date'] === null) {
            $invalidProperties[] = "'latest_accounts_end_date' can't be null";
        }
    ...
    /**
     * Gets latest_accounts_start_date
     *
     * @return \DateTime
     */
    public function getLatestAccountsStartDate()
    {
        return $this->container['latest_accounts_start_date'];
    }

    /**
     * Sets latest_accounts_start_date
     *
     * @param \DateTime $latest_accounts_start_date latest_accounts_start_date
     *
     * @return $this
     */
    public function setLatestAccountsStartDate($latest_accounts_start_date)
    {
        $this->container['latest_accounts_start_date'] = $latest_accounts_start_date;

        return $this;
    }

    /**
     * Gets latest_accounts_end_date
     *
     * @return \DateTime
     */
    public function getLatestAccountsEndDate()
    {
        return $this->container['latest_accounts_end_date'];
    }

    /**
     * Sets latest_accounts_end_date
     *
     * @param \DateTime $latest_accounts_end_date latest_accounts_end_date
     *
     * @return $this
     */
    public function setLatestAccountsEndDate($latest_accounts_end_date)
    {
        $this->container['latest_accounts_end_date'] = $latest_accounts_end_date;
     ...
     *
     * @param bool $charity_only_accounts charity_only_accounts
     *
     * @return $this
     */
