<?php
/**
 * PEPsAndSanctionsAnyBusinessCriteria
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PEPsAndSanctionsAnyBusinessCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PEPsAndSanctionsAnyBusinessCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PEPsAndSanctionsAnyBusinessCriteria';
    ...
    {
        $this->container['any_business'] = isset($data['any_business']) ? $data['any_business'] : null;
    }
     ...
     * @return object
     */
    public function getAnyBusiness()
    {
        return $this->container['any_business'];
    }

    /**
     * Sets any_business
     *
     * @param object $any_business any_business
     *
     * @return $this
     */
    public function setAnyBusiness($any_business)
    {
        $this->container['any_business'] = $any_business;
