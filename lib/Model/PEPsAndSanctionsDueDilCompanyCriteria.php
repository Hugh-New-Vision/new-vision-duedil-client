<?php
/**
 * PEPsAndSanctionsDueDilCompanyCriteria
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PEPsAndSanctionsDueDilCompanyCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PEPsAndSanctionsDueDilCompanyCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PEPsAndSanctionsDueDilCompanyCriteria';
    ...
    protected static $swaggerTypes = [
        'duedil_company' => '\Swagger\Client\Model\PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany'
    ];
    ...
    protected static $setters = [
        'duedil_company' => 'setDuedilCompany'
    ];
    ...
    protected static $getters = [
        'duedil_company' => 'getDuedilCompany'
    ];
    ...
    {
        $this->container['duedil_company'] = isset($data['duedil_company']) ? $data['duedil_company'] : null;
    }
     ...
     * Gets duedil_company
     *
     * @return \Swagger\Client\Model\PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany
     */
    public function getDuedilCompany()
    {
        return $this->container['duedil_company'];
    }

    /**
     * Sets duedil_company
     *
     * @param \Swagger\Client\Model\PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany $duedil_company duedil_company
     *
     * @return $this
     */
    public function setDuedilCompany($duedil_company)
    {
        $this->container['duedil_company'] = $duedil_company;
