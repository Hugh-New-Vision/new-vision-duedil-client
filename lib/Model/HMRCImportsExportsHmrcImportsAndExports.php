<?php
/**
 * HMRCImportsExportsHmrcImportsAndExports
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * HMRCImportsExportsHmrcImportsAndExports Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HMRCImportsExportsHmrcImportsAndExports implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HMRCImportsExports_hmrcImportsAndExports';
    ...
    protected static $swaggerTypes = [
        'commodity' => '\Swagger\Client\Model\HMRCImportsExportsCommodity',
        'trade_direction' => 'string',
        'date' => '\Swagger\Client\Model\SharedPersonMatchDateOfBirth'
    ];
    ...
    protected static $setters = [
        ...
        'trade_direction' => 'setTradeDirection',
        'date' => 'setDate'
    ];
    ...
    protected static $getters = [
        ...
        'trade_direction' => 'getTradeDirection',
        'date' => 'getDate'
    ];
    ...
    const TRADE_DIRECTION_IMPORT = 'import';
    const TRADE_DIRECTION_EXPORT = 'export';
     ...
     * @return string[]
     */
    public function getTradeDirectionAllowableValues()
    {
        return [
            self::TRADE_DIRECTION_IMPORT,
            self::TRADE_DIRECTION_EXPORT,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['trade_direction'] = isset($data['trade_direction']) ? $data['trade_direction'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trade_direction'] === null) {
            $invalidProperties[] = "'trade_direction' can't be null";
        }
        $allowedValues = $this->getTradeDirectionAllowableValues();
        if (!is_null($this->container['trade_direction']) && !in_array($this->container['trade_direction'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'trade_direction', must be one of '%s'",
     ...
     * Gets commodity
     *
     * @return \Swagger\Client\Model\HMRCImportsExportsCommodity
     */
     ...
     * Sets commodity
     *
     * @param \Swagger\Client\Model\HMRCImportsExportsCommodity $commodity commodity
     *
     * @return $this
     */
    ...
    /**
     * Gets trade_direction
     *
     * @return string
     */
    public function getTradeDirection()
    {
        return $this->container['trade_direction'];
    }

    /**
     * Sets trade_direction
     *
     * @param string $trade_direction trade_direction
     *
     * @return $this
     */
    public function setTradeDirection($trade_direction)
    {
        $allowedValues = $this->getTradeDirectionAllowableValues();
        if (!in_array($trade_direction, $allowedValues, true)) {
        ...
        $this->container['trade_direction'] = $trade_direction;
     ...
     * Sets date
     *
     * @param \Swagger\Client\Model\SharedPersonMatchDateOfBirth $date date
     *
     * @return $this
     */
