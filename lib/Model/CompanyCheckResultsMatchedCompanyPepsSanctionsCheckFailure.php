<?php
/**
 * CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_pepsSanctionsCheck_failure';
    ...
    protected static $swaggerFormats = [
        ...
        'matches_triggering_failure' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'matches_triggering_failure' => 'matchesTriggeringFailure'
    ];
    ...
    protected static $setters = [
        ...
        'matches_triggering_failure' => 'setMatchesTriggeringFailure'
    ];
    ...
    protected static $getters = [
        ...
        'matches_triggering_failure' => 'getMatchesTriggeringFailure'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['matches_triggering_failure'] = isset($data['matches_triggering_failure']) ? $data['matches_triggering_failure'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['matches_triggering_failure'] === null) {
            $invalidProperties[] = "'matches_triggering_failure' can't be null";
        }
    ...
    /**
     * Gets matches_triggering_failure
     *
     * @return float
     */
    public function getMatchesTriggeringFailure()
    {
        return $this->container['matches_triggering_failure'];
    }

    /**
     * Sets matches_triggering_failure
     *
     * @param float $matches_triggering_failure matches_triggering_failure
     *
     * @return $this
     */
    public function setMatchesTriggeringFailure($matches_triggering_failure)
    {
        $this->container['matches_triggering_failure'] = $matches_triggering_failure;
