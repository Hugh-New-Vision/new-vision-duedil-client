...
/**
 * CallcreditIdentityCheckResponseCallcreditSHARE Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseCallcreditSHARE implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_callcreditSHARE';
    ...
    protected static $swaggerFormats = [
        'share_record_count' => null,
        'share_level_of_confidence' => null
    ];
    ...
    protected static $attributeMap = [
        'share_record_count' => 'shareRecordCount',
        'share_level_of_confidence' => 'shareLevelOfConfidence'
    ];
    ...
    protected static $setters = [
        'share_record_count' => 'setShareRecordCount',
        'share_level_of_confidence' => 'setShareLevelOfConfidence'
    ];
    ...
    protected static $getters = [
        'share_record_count' => 'getShareRecordCount',
        'share_level_of_confidence' => 'getShareLevelOfConfidence'
    ];
    ...
    {
        $this->container['share_record_count'] = isset($data['share_record_count']) ? $data['share_record_count'] : null;
        $this->container['share_level_of_confidence'] = isset($data['share_level_of_confidence']) ? $data['share_level_of_confidence'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['share_record_count'] === null) {
            $invalidProperties[] = "'share_record_count' can't be null";
        }
        if ($this->container['share_level_of_confidence'] === null) {
            $invalidProperties[] = "'share_level_of_confidence' can't be null";
        }
    ...
    /**
     * Gets share_record_count
     *
     * @return int
     */
    public function getShareRecordCount()
    {
        return $this->container['share_record_count'];
    }

    /**
     * Sets share_record_count
     *
     * @param int $share_record_count Number of records found for the individual on Callcredit's SHARE database
     *
     * @return $this
     */
    public function setShareRecordCount($share_record_count)
    {
        $this->container['share_record_count'] = $share_record_count;

        return $this;
    }

    /**
     * Gets share_level_of_confidence
     *
     * @return int
     */
    public function getShareLevelOfConfidence()
    {
        return $this->container['share_level_of_confidence'];
    }

    /**
     * Sets share_level_of_confidence
     *
     * @param int $share_level_of_confidence share_level_of_confidence
     *
     * @return $this
     */
    public function setShareLevelOfConfidence($share_level_of_confidence)
    {
        $this->container['share_level_of_confidence'] = $share_level_of_confidence;
