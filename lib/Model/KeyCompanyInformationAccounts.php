...
/**
 * KeyCompanyInformationAccounts Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeyCompanyInformationAccounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeyCompanyInformation_accounts';
    ...
    protected static $swaggerTypes = [
        'filing_type' => 'string',
        'currency' => 'string',
        'latest_accounts_date' => '\DateTime',
        'consolidated_accounts' => 'bool',
        'next_accounts_due_date' => '\DateTime'
    ];
     ...
     *
     * @param \DateTime $latest_accounts_date latest_accounts_date
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $next_accounts_due_date next_accounts_due_date
     *
     * @return $this
     */
