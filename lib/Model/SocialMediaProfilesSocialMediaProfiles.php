<?php
/**
 * SocialMediaProfilesSocialMediaProfiles
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SocialMediaProfilesSocialMediaProfiles Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialMediaProfilesSocialMediaProfiles implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialMediaProfiles_socialMediaProfiles';
     ...
     * Sets platform
     *
     * @param string $platform Social media profile platform
     *
     * @return $this
     */
     ...
     * Sets handle
     *
     * @param string $handle Social media profile handle
     *
     * @return $this
     */
