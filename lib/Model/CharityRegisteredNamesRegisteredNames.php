<?php
/**
 * CharityRegisteredNamesRegisteredNames
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CharityRegisteredNamesRegisteredNames Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CharityRegisteredNamesRegisteredNames implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CharityRegisteredNames_registeredNames';
     ...
     * Sets type
     *
     * @param string $type * `official`: The name as it appears/has appeared on official filings * `working`: Other names (e.g. shortened, or \"brand\" names, or aliases) that the Charity may have used.
     *
     * @return $this
     */
