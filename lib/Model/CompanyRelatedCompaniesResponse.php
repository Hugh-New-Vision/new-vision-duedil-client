<?php
/**
 * CompanyRelatedCompaniesResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyRelatedCompaniesResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyRelatedCompaniesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyRelatedCompaniesResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'related_companies' => '\Swagger\Client\Model\RelatedCompaniesRelatedCompanies[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['related_companies'] = isset($data['related_companies']) ? $data['related_companies'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['related_companies'] === null) {
            $invalidProperties[] = "'related_companies' can't be null";
        }
     ...
     *
     * @return \Swagger\Client\Model\RelatedCompaniesRelatedCompanies[]
     */
     ...
     *
     * @param \Swagger\Client\Model\RelatedCompaniesRelatedCompanies[] $related_companies related_companies
     *
     * @return $this
     */
