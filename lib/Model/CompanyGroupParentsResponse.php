...
/**
 * CompanyGroupParentsResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyGroupParentsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyGroupParentsResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'group_parents' => '\Swagger\Client\Model\CompanyGroupParentsGroupParents[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['group_parents'] = isset($data['group_parents']) ? $data['group_parents'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['group_parents'] === null) {
            $invalidProperties[] = "'group_parents' can't be null";
        }
     ...
     * Gets group_parents
     *
     * @return \Swagger\Client\Model\CompanyGroupParentsGroupParents[]
     */
    public function getGroupParents()
    {
        return $this->container['group_parents'];
    }

    /**
     * Sets group_parents
     *
     * @param \Swagger\Client\Model\CompanyGroupParentsGroupParents[] $group_parents group_parents
     *
     * @return $this
     */
    public function setGroupParents($group_parents)
    {
        $this->container['group_parents'] = $group_parents;
