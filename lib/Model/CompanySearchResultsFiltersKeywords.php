<?php
/**
 * CompanySearchResultsFiltersKeywords
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchResultsFiltersKeywords Class Doc Comment
 *
 * @category Class
 * @description Optional keywords issued in the search request
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchResultsFiltersKeywords implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanySearchResults_filters_keywords';
    ...
    protected static $swaggerTypes = [
        'values' => 'string[]',
        'mode' => 'string',
        'except' => '\Swagger\Client\Model\CompanySearchResultsFiltersKeywordsExcept'
    ];
     ...
     * Gets except
     *
     * @return \Swagger\Client\Model\CompanySearchResultsFiltersKeywordsExcept
     */
     ...
     * Sets except
     *
     * @param \Swagger\Client\Model\CompanySearchResultsFiltersKeywordsExcept $except except
     *
     * @return $this
     */
