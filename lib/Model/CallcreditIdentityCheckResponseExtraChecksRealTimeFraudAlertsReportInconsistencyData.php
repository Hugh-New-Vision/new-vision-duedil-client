...
/**
 * CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_realTimeFraudAlerts_report_inconsistencyData';
    ...
    protected static $swaggerTypes = [
        'group' => 'string',
        'inconsistencies' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyDataInconsistencies[]'
    ];
    ...
    protected static $setters = [
        'group' => 'setGroup',
        'inconsistencies' => 'setInconsistencies'
    ];
    ...
    const GROUP_IDENTITY = 'Identity';
    const GROUP_ADDRESS = 'Address';
    const GROUP_DATE_OF_BIRTH = 'DateOfBirth';
    const GROUP_BANK_DETAILS = 'BankDetails';
    const GROUP_CARD_DETAILS = 'CardDetails';
    const GROUP_EMAIL_ADDRESS = 'EmailAddress';
    const GROUP_IP_ADDRESS = 'IPAddress';
    const GROUP_TELEPHONE_NUMBER = 'TelephoneNumber';
    ...
    public function getGroupAllowableValues()
    {
        return [
            self::GROUP_IDENTITY,
            self::GROUP_ADDRESS,
            self::GROUP_DATE_OF_BIRTH,
            self::GROUP_BANK_DETAILS,
            self::GROUP_CARD_DETAILS,
            self::GROUP_EMAIL_ADDRESS,
            self::GROUP_IP_ADDRESS,
            self::GROUP_TELEPHONE_NUMBER,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inconsistencies'] = isset($data['inconsistencies']) ? $data['inconsistencies'] : null;
    }
     ...
     * Sets group
     *
     * @param string $group The ‘Type’ attribute defines the Inconsistency data item which matches the input data that the results have been generated for. The ‘Type’ attribute can be one of the following below.
     *
     * @return $this
     */
    ...
    /**
     * Gets inconsistencies
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyDataInconsistencies[]
     */
    public function getInconsistencies()
    {
        return $this->container['inconsistencies'];
    }

    /**
     * Sets inconsistencies
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyDataInconsistencies[] $inconsistencies Contains results from the data velocity checks within Real-Time Fraud Alerts
     *
     * @return $this
     */
    public function setInconsistencies($inconsistencies)
    {
        $this->container['inconsistencies'] = $inconsistencies;
