<?php
/**
 * RelatedCompaniesMutualAddresses
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RelatedCompaniesMutualAddresses Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RelatedCompaniesMutualAddresses implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RelatedCompanies_mutualAddresses';
     ...
     * Sets count
     *
     * @param int $count Number of mutual addresses between the source and destination companies
     *
     * @return $this
     */
