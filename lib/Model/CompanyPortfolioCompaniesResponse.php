<?php
/**
 * CompanyPortfolioCompaniesResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyPortfolioCompaniesResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyPortfolioCompaniesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyPortfolioCompaniesResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'portfolio_companies' => '\Swagger\Client\Model\CompanyPortfolioCompaniesPortfolioCompanies[]'
    ];
    ...
    protected static $setters = [
        ...
        'portfolio_companies' => 'setPortfolioCompanies'
    ];
    ...
    protected static $getters = [
        ...
        'portfolio_companies' => 'getPortfolioCompanies'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['portfolio_companies'] = isset($data['portfolio_companies']) ? $data['portfolio_companies'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['portfolio_companies'] === null) {
            $invalidProperties[] = "'portfolio_companies' can't be null";
        }
    ...
    /**
     * Gets portfolio_companies
     *
     * @return \Swagger\Client\Model\CompanyPortfolioCompaniesPortfolioCompanies[]
     */
    public function getPortfolioCompanies()
    {
        return $this->container['portfolio_companies'];
    }

    /**
     * Sets portfolio_companies
     *
     * @param \Swagger\Client\Model\CompanyPortfolioCompaniesPortfolioCompanies[] $portfolio_companies portfolio_companies
     *
     * @return $this
     */
    public function setPortfolioCompanies($portfolio_companies)
    {
        $this->container['portfolio_companies'] = $portfolio_companies;
