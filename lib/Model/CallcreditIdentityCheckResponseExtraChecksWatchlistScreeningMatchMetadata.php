<?php
/**
 * CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningMatchMetadata
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningMatchMetadata Class Doc Comment
 *
 * @category Class
 * @description Contains metadata about the match
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningMatchMetadata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_watchlistScreening_matchMetadata';
    ...
    protected static $setters = [
        'matched_name' => 'setMatchedName',
        'matched_name_type' => 'setMatchedNameType',
    ...
    protected static $getters = [
        'matched_name' => 'getMatchedName',
        'matched_name_type' => 'getMatchedNameType',
    ...
    {
        $this->container['matched_name'] = isset($data['matched_name']) ? $data['matched_name'] : null;
        $this->container['matched_name_type'] = isset($data['matched_name_type']) ? $data['matched_name_type'] : null;
    ...
    {
        return $this->container['matched_name'];
    }

    /**
     * Sets matched_name
     *
     * @param string $matched_name The exact name of the potential match
     *
     * @return $this
     */
    public function setMatchedName($matched_name)
    {
        $this->container['matched_name'] = $matched_name;

        return $this;
    }

    /**
     * Gets matched_name_type
     *
     * @return string
     */
    public function getMatchedNameType()
    {
        return $this->container['matched_name_type'];
    }

    /**
     * Sets matched_name_type
     *
     * @param string $matched_name_type The type of Name Match achieved
     *
     * @return $this
     */
    public function setMatchedNameType($matched_name_type)
    {
        $this->container['matched_name_type'] = $matched_name_type;
     ...
     * Sets match_score
     *
     * @param int $match_score The match score associated with the record. Ranging from 0 (low confidence) to 1 (high confidence), e.g. 0.89
     *
     * @return $this
     */
