...
/**
 * CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_realTimeFraudAlerts_report';
    ...
    protected static $swaggerTypes = [
        'summary' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary',
        'velocity_data' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportVelocityData[]',
        'inconsistency_data' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyData'
    ];
    ...
    protected static $attributeMap = [
        ...
        'inconsistency_data' => 'inconsistencyData'
    ];
    ...
    protected static $setters = [
        'summary' => 'setSummary',
        'velocity_data' => 'setVelocityData',
        'inconsistency_data' => 'setInconsistencyData'
    ];
    ...
    protected static $getters = [
        'summary' => 'getSummary',
        'velocity_data' => 'getVelocityData',
        'inconsistency_data' => 'getInconsistencyData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['velocity_data'] = isset($data['velocity_data']) ? $data['velocity_data'] : null;
        $this->container['inconsistency_data'] = isset($data['inconsistency_data']) ? $data['inconsistency_data'] : null;
    }
     ...
     * Gets summary
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary
     */
     ...
     * Sets summary
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary $summary summary
     *
     * @return $this
     */
     ...
     * Gets velocity_data
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportVelocityData[]
     */
    public function getVelocityData()
    {
        return $this->container['velocity_data'];
    }

    /**
     * Sets velocity_data
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportVelocityData[] $velocity_data Contains results from the data velocity checks within Real-Time Fraud Alerts
     *
     * @return $this
     */
    public function setVelocityData($velocity_data)
    {
        $this->container['velocity_data'] = $velocity_data;

        return $this;
    }

    /**
     * Gets inconsistency_data
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyData
     */
    public function getInconsistencyData()
    {
        return $this->container['inconsistency_data'];
    }

    /**
     * Sets inconsistency_data
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyData $inconsistency_data inconsistency_data
     *
     * @return $this
     */
    public function setInconsistencyData($inconsistency_data)
    {
        $this->container['inconsistency_data'] = $inconsistency_data;
