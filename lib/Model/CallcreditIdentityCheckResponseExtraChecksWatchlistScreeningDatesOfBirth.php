<?php
/**
 * CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningDatesOfBirth
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningDatesOfBirth Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningDatesOfBirth implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_watchlistScreening_datesOfBirth';
     ...
     * Sets day
     *
     * @param int $day Day of birth of the potential match
     *
     * @return $this
     */
     ...
     * Sets month
     *
     * @param int $month Month of birth of the potential match
     *
     * @return $this
     */
     ...
     * Sets year
     *
     * @param int $year Year of birth of the potential match
     *
     * @return $this
     */
