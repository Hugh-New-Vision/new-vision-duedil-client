<?php
/**
 * CharityRegisteredNamesResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CharityRegisteredNamesResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CharityRegisteredNamesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CharityRegisteredNamesResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'registered_names' => '\Swagger\Client\Model\CharityRegisteredNamesRegisteredNames[]'
    ];
    ...
    protected static $setters = [
        ...
        'registered_names' => 'setRegisteredNames'
    ];
    ...
    protected static $getters = [
        ...
        'registered_names' => 'getRegisteredNames'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['registered_names'] = isset($data['registered_names']) ? $data['registered_names'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['charity_id'] === null) {
            $invalidProperties[] = "'charity_id' can't be null";
        }
        if ($this->container['pagination'] === null) {
            $invalidProperties[] = "'pagination' can't be null";
        }
        if ($this->container['registered_names'] === null) {
            $invalidProperties[] = "'registered_names' can't be null";
        }
     ...
     * Sets charity_id
     *
     * @param string $charity_id Charity registration and subsidiary numbers in format `charityId-subsidiaryNumber`
     *
     * @return $this
     */
    ...
    /**
     * Gets registered_names
     *
     * @return \Swagger\Client\Model\CharityRegisteredNamesRegisteredNames[]
     */
    public function getRegisteredNames()
    {
        return $this->container['registered_names'];
    }

    /**
     * Sets registered_names
     *
     * @param \Swagger\Client\Model\CharityRegisteredNamesRegisteredNames[] $registered_names All charity names (including old official and working names)
     *
     * @return $this
     */
    public function setRegisteredNames($registered_names)
    {
        $this->container['registered_names'] = $registered_names;
