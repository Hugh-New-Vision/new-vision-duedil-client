...
/**
 * HMRCImportsExportsCommodity Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HMRCImportsExportsCommodity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HMRCImportsExports_commodity';
     ...
     * Sets code
     *
     * @param string $code Commodity code classification of goods for import and export
     *
     * @return $this
     */
