...
/**
 * StructuredAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StructuredAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StructuredAddress';
    ...
    {
        $this->container['premises'] = isset($data['premises']) ? $data['premises'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['premises'] === null) {
            $invalidProperties[] = "'premises' can't be null";
        }
        if ($this->container['thoroughfare'] === null) {
            $invalidProperties[] = "'thoroughfare' can't be null";
        }
        if ($this->container['dependent_locality'] === null) {
            $invalidProperties[] = "'dependent_locality' can't be null";
        }
        if ($this->container['post_town'] === null) {
            $invalidProperties[] = "'post_town' can't be null";
        }
    ...
    {
        return $this->container['premises'];
    }
    ...
    {
        $this->container['premises'] = $premises;
     ...
     * Sets thoroughfare
     *
     * @param string $thoroughfare thoroughfare
     *
     * @return $this
     */
     ...
     *
     * @param string $dependent_locality dependent_locality
     *
     * @return $this
     */
     ...
     * Sets post_town
     *
     * @param string $post_town post_town
     *
     * @return $this
     */
