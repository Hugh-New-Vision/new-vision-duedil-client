<?php
/**
 * CompanyCheckResultsMatchedCompanyPersonNationalities
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyPersonNationalities Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyPersonNationalities implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_person_nationalities';
    ...
    {
        $this->container['demonym'] = isset($data['demonym']) ? $data['demonym'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['demonym'] === null) {
            $invalidProperties[] = "'demonym' can't be null";
        }
    ...
    {
        return $this->container['demonym'];
    }

    /**
     * Sets demonym
     *
     * @param string $demonym demonym
     *
     * @return $this
     */
    public function setDemonym($demonym)
    {
        $this->container['demonym'] = $demonym;
