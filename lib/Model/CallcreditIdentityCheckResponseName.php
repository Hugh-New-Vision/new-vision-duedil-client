<?php
/**
 * CallcreditIdentityCheckResponseName
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CallcreditIdentityCheckResponseName Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseName implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_name';
    ...
    protected static $attributeMap = [
        'name_pick_list_found' => 'namePickListFound',
    ...
    protected static $setters = [
        'name_pick_list_found' => 'setNamePickListFound',
        'name_matched' => 'setNameMatched'
    ];
    ...
    protected static $getters = [
        'name_pick_list_found' => 'getNamePickListFound',
        'name_matched' => 'getNameMatched'
    ];
    ...
    {
        $this->container['name_pick_list_found'] = isset($data['name_pick_list_found']) ? $data['name_pick_list_found'] : null;
        $this->container['name_matched'] = isset($data['name_matched']) ? $data['name_matched'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name_pick_list_found'] === null) {
            $invalidProperties[] = "'name_pick_list_found' can't be null";
        }
        if ($this->container['name_matched'] === null) {
            $invalidProperties[] = "'name_matched' can't be null";
        }
    ...
    /**
     * Gets name_pick_list_found
     *
     * @return bool
     */
    public function getNamePickListFound()
    {
        return $this->container['name_pick_list_found'];
    }

    /**
     * Sets name_pick_list_found
     *
     * @param bool $name_pick_list_found name_pick_list_found
     *
     * @return $this
     */
    public function setNamePickListFound($name_pick_list_found)
    {
        $this->container['name_pick_list_found'] = $name_pick_list_found;
     ...
     * @return string
     */
    public function getNameMatched()
    {
        return $this->container['name_matched'];
    }

    /**
     * Sets name_matched
     *
     * @param string $name_matched name_matched
     *
     * @return $this
     */
    public function setNameMatched($name_matched)
    {
        $this->container['name_matched'] = $name_matched;
