...
/**
 * RegionsMultiValueFilter Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegionsMultiValueFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionsMultiValueFilter';
    ...
    protected static $swaggerTypes = [
        'values' => '\Swagger\Client\Model\RegionsMultiValueFilterValues[]',
        'mode' => 'string',
        'except' => '\Swagger\Client\Model\RegionsMultiValueFilterExcept'
    ];
     ...
     * Gets values
     *
     * @return \Swagger\Client\Model\RegionsMultiValueFilterValues[]
     */
     ...
     * Sets values
     *
     * @param \Swagger\Client\Model\RegionsMultiValueFilterValues[] $values values
     *
     * @return $this
     */
     ...
     * Sets mode
     *
     * @param string $mode Boolean logic mode. Defaults to any. **NOTE: We plan on adding more modes soon. Some of the existing modes might not be implemented for all filters**
     *
     * @return $this
     */
     ...
     * Gets except
     *
     * @return \Swagger\Client\Model\RegionsMultiValueFilterExcept
     */
     ...
     * Sets except
     *
     * @param \Swagger\Client\Model\RegionsMultiValueFilterExcept $except except
     *
     * @return $this
     */
