<?php
/**
 * CharityAreasOfActivityResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CharityAreasOfActivityResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CharityAreasOfActivityResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CharityAreasOfActivityResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'areas_of_activity' => '\Swagger\Client\Model\CharityTrusteesTrustees[]'
    ];
    ...
    protected static $setters = [
        ...
        'areas_of_activity' => 'setAreasOfActivity'
    ];
    ...
    protected static $getters = [
        ...
        'areas_of_activity' => 'getAreasOfActivity'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['areas_of_activity'] = isset($data['areas_of_activity']) ? $data['areas_of_activity'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['areas_of_activity'] === null) {
            $invalidProperties[] = "'areas_of_activity' can't be null";
        }
    ...
    /**
     * Gets areas_of_activity
     *
     * @return \Swagger\Client\Model\CharityTrusteesTrustees[]
     */
    public function getAreasOfActivity()
    {
        return $this->container['areas_of_activity'];
    }

    /**
     * Sets areas_of_activity
     *
     * @param \Swagger\Client\Model\CharityTrusteesTrustees[] $areas_of_activity areas_of_activity
     *
     * @return $this
     */
    public function setAreasOfActivity($areas_of_activity)
    {
        $this->container['areas_of_activity'] = $areas_of_activity;
