<?php
/**
 * CompanyGroupParentsGroupParents
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyGroupParentsGroupParents Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyGroupParentsGroupParents implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyGroupParents_groupParents';
    ...
    protected static $swaggerFormats = [
        ...
        'company_id' => null,
        'name' => null,
        'degree_of_separation' => 'int32',
        'is_immediate_parent' => null,
    ...
    protected static $attributeMap = [
        ...
        'is_immediate_parent' => 'isImmediateParent',
        'is_ultimate_parent' => 'isUltimateParent'
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'degree_of_separation' => 'setDegreeOfSeparation',
        'is_immediate_parent' => 'setIsImmediateParent',
        'is_ultimate_parent' => 'setIsUltimateParent'
    ];
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'degree_of_separation' => 'getDegreeOfSeparation',
        'is_immediate_parent' => 'getIsImmediateParent',
        'is_ultimate_parent' => 'getIsUltimateParent'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['degree_of_separation'] = isset($data['degree_of_separation']) ? $data['degree_of_separation'] : null;
        $this->container['is_immediate_parent'] = isset($data['is_immediate_parent']) ? $data['is_immediate_parent'] : null;
        $this->container['is_ultimate_parent'] = isset($data['is_ultimate_parent']) ? $data['is_ultimate_parent'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['degree_of_separation'] === null) {
            $invalidProperties[] = "'degree_of_separation' can't be null";
        }
        if ($this->container['is_immediate_parent'] === null) {
            $invalidProperties[] = "'is_immediate_parent' can't be null";
        }
        if ($this->container['is_ultimate_parent'] === null) {
            $invalidProperties[] = "'is_ultimate_parent' can't be null";
        }
    ...
    /**
     * Gets degree_of_separation
     *
     * @return int
     */
    public function getDegreeOfSeparation()
    {
        return $this->container['degree_of_separation'];
    }

    /**
     * Sets degree_of_separation
     *
     * @param int $degree_of_separation degree_of_separation
     *
     * @return $this
     */
    public function setDegreeOfSeparation($degree_of_separation)
    {
        $this->container['degree_of_separation'] = $degree_of_separation;

        return $this;
    }

    /**
     * Gets is_immediate_parent
     *
     * @return bool
     */
    public function getIsImmediateParent()
    {
        return $this->container['is_immediate_parent'];
    }

    /**
     * Sets is_immediate_parent
     *
     * @param bool $is_immediate_parent is_immediate_parent
     *
     * @return $this
     */
    public function setIsImmediateParent($is_immediate_parent)
    {
        $this->container['is_immediate_parent'] = $is_immediate_parent;

        return $this;
    }

    /**
     * Gets is_ultimate_parent
     *
     * @return bool
     */
    public function getIsUltimateParent()
    {
        return $this->container['is_ultimate_parent'];
    }

    /**
     * Sets is_ultimate_parent
     *
     * @param bool $is_ultimate_parent is_ultimate_parent
     *
     * @return $this
     */
    public function setIsUltimateParent($is_ultimate_parent)
    {
        $this->container['is_ultimate_parent'] = $is_ultimate_parent;
