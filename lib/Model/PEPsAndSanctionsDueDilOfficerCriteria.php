<?php
/**
 * PEPsAndSanctionsDueDilOfficerCriteria
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PEPsAndSanctionsDueDilOfficerCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PEPsAndSanctionsDueDilOfficerCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PEPsAndSanctionsDueDilOfficerCriteria';
    ...
    protected static $swaggerTypes = [
        'duedil_officer' => '\Swagger\Client\Model\PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer'
    ];
    ...
    protected static $setters = [
        'duedil_officer' => 'setDuedilOfficer'
    ];
    ...
    protected static $getters = [
        'duedil_officer' => 'getDuedilOfficer'
    ];
    ...
    {
        $this->container['duedil_officer'] = isset($data['duedil_officer']) ? $data['duedil_officer'] : null;
    }
     ...
     * Gets duedil_officer
     *
     * @return \Swagger\Client\Model\PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer
     */
    public function getDuedilOfficer()
    {
        return $this->container['duedil_officer'];
    }

    /**
     * Sets duedil_officer
     *
     * @param \Swagger\Client\Model\PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer $duedil_officer duedil_officer
     *
     * @return $this
     */
    public function setDuedilOfficer($duedil_officer)
    {
        $this->container['duedil_officer'] = $duedil_officer;
