<?php
/**
 * PEPsAndSanctionsDocumentCategories
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PEPsAndSanctionsDocumentCategories Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PEPsAndSanctionsDocumentCategories implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PEPsAndSanctionsDocument_categories';
    ...
    const NAME_ADVERSE_MEDIA = 'Adverse Media';
    const NAME_CORPORATEBUSINESS = 'Corporate/Business';
    const NAME_DISQUALIFIED_DIRECTOR = 'Disqualified Director';
    const NAME_FINANCIAL_REGULATOR = 'Financial Regulator';
    const NAME_IDV = 'ID/V';
    const NAME_INSOLVENT = 'Insolvent';
    const NAME_LAW_ENFORCEMENT = 'Law Enforcement';
    const NAME_PEP = 'PEP';
    const NAME_SANCTION = 'Sanction';
    ...
    {
        return [
            self::NAME_ADVERSE_MEDIA,
            self::NAME_CORPORATEBUSINESS,
            self::NAME_DISQUALIFIED_DIRECTOR,
            self::NAME_FINANCIAL_REGULATOR,
            self::NAME_IDV,
            self::NAME_INSOLVENT,
            self::NAME_LAW_ENFORCEMENT,
            self::NAME_PEP,
            self::NAME_SANCTION,
        ];
    }
