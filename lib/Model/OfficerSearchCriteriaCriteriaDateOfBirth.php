<?php
/**
 * OfficerSearchCriteriaCriteriaDateOfBirth
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OfficerSearchCriteriaCriteriaDateOfBirth Class Doc Comment
 *
 * @category Class
 * @description Officers whose date of birth falls within the given range
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OfficerSearchCriteriaCriteriaDateOfBirth implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OfficerSearchCriteria_criteria_dateOfBirth';
