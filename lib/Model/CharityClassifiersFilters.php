...
/**
 * CharityClassifiersFilters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CharityClassifiersFilters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CharityClassifiers_filters';
    ...
    const TYPES_PURPOSE = 'purpose';
    const TYPES_ACTIVITY = 'activity';
    const TYPES_BENEFICIARY = 'beneficiary';
