...
/**
 * CallcreditIdentityCheckResponseDeceased Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseDeceased implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_deceased';
    ...
    protected static $attributeMap = [
        'gro_match' => 'groMatch',
        'halo_match' => 'haloMatch',
        'halo_level_of_confidence' => 'haloLevelOfConfidence'
    ];
    ...
    protected static $setters = [
        'gro_match' => 'setGroMatch',
        'halo_match' => 'setHaloMatch',
        'halo_level_of_confidence' => 'setHaloLevelOfConfidence'
    ];
    ...
    protected static $getters = [
        'gro_match' => 'getGroMatch',
        'halo_match' => 'getHaloMatch',
        'halo_level_of_confidence' => 'getHaloLevelOfConfidence'
    ];
    ...
    {
        $this->container['gro_match'] = isset($data['gro_match']) ? $data['gro_match'] : null;
        $this->container['halo_match'] = isset($data['halo_match']) ? $data['halo_match'] : null;
        $this->container['halo_level_of_confidence'] = isset($data['halo_level_of_confidence']) ? $data['halo_level_of_confidence'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['gro_match'] === null) {
            $invalidProperties[] = "'gro_match' can't be null";
        }
        if ($this->container['halo_match'] === null) {
            $invalidProperties[] = "'halo_match' can't be null";
        }
        if ($this->container['halo_level_of_confidence'] === null) {
            $invalidProperties[] = "'halo_level_of_confidence' can't be null";
        }
     ...
     * @return bool
     */
    public function getGroMatch()
    {
        return $this->container['gro_match'];
    }

    /**
     * Sets gro_match
     *
     * @param bool $gro_match Whether or not the individual is found to be deceased on the [General Register Office](http://www.gro.gov.uk/).
     *
     * @return $this
     */
    public function setGroMatch($gro_match)
    {
        $this->container['gro_match'] = $gro_match;
     ...
     * @return bool
     */
    public function getHaloMatch()
    {
        return $this->container['halo_match'];
    }

    /**
     * Sets halo_match
     *
     * @param bool $halo_match Whether or not the individual is found on the [Halo](http://www.halofraudprevention.com/) database of deceased records.
     *
     * @return $this
     */
    public function setHaloMatch($halo_match)
    {
        $this->container['halo_match'] = $halo_match;

        return $this;
    }

    /**
     * Gets halo_level_of_confidence
     *
     * @return int
     */
    public function getHaloLevelOfConfidence()
    {
        return $this->container['halo_level_of_confidence'];
    }

    /**
     * Sets halo_level_of_confidence
     *
     * @param int $halo_level_of_confidence halo_level_of_confidence
     *
     * @return $this
     */
    public function setHaloLevelOfConfidence($halo_level_of_confidence)
    {
        $this->container['halo_level_of_confidence'] = $halo_level_of_confidence;
