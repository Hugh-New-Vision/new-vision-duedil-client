<?php
/**
 * CompanyCreditReportCreditReportCreditLimit
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCreditReportCreditReportCreditLimit Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCreditReportCreditReportCreditLimit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCreditReport_creditReport_creditLimit';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['since_date'] === null) {
            $invalidProperties[] = "'since_date' can't be null";
        }
