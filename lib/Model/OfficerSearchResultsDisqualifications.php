<?php
/**
 * OfficerSearchResultsDisqualifications
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OfficerSearchResultsDisqualifications Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OfficerSearchResultsDisqualifications implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OfficerSearchResults_disqualifications';
    ...
    protected static $swaggerTypes = [
        'legislation' => '\Swagger\Client\Model\OfficerSearchResultsLegislation',
        'start_date' => '\DateTime',
        'end_date' => '\DateTime'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['legislation'] === null) {
            $invalidProperties[] = "'legislation' can't be null";
        }
     ...
     * Gets legislation
     *
     * @return \Swagger\Client\Model\OfficerSearchResultsLegislation
     */
     ...
     * Sets legislation
     *
     * @param \Swagger\Client\Model\OfficerSearchResultsLegislation $legislation legislation
     *
     * @return $this
     */
