<?php
/**
 * CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_shareholdersGreaterOrEqualTenPercent';
    ...
    protected static $swaggerTypes = [
        ...
        'shareholdings' => '\Swagger\Client\Model\CompanyCheckResultsMatchedCompanyShareholdings[]',
        'exact_matches' => 'object[]',
        'possible_matches' => '\Swagger\Client\Model\CompanyCheckPossibleMatch[]',
        'not_matched' => '\Swagger\Client\Model\SharedNotMatched'
    ];
    ...
    protected static $attributeMap = [
        ...
        'total_shareholding' => 'totalShareholding',
        'total_shareholding_percentage' => 'totalShareholdingPercentage',
    ...
    protected static $setters = [
        ...
        'total_shareholding' => 'setTotalShareholding',
        'total_shareholding_percentage' => 'setTotalShareholdingPercentage',
        'shareholdings' => 'setShareholdings',
        'exact_matches' => 'setExactMatches',
        'possible_matches' => 'setPossibleMatches',
        'not_matched' => 'setNotMatched'
    ];
    ...
    protected static $getters = [
        ...
        'total_shareholding' => 'getTotalShareholding',
        'total_shareholding_percentage' => 'getTotalShareholdingPercentage',
        'shareholdings' => 'getShareholdings',
        'exact_matches' => 'getExactMatches',
        'possible_matches' => 'getPossibleMatches',
        'not_matched' => 'getNotMatched'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_shareholding'] = isset($data['total_shareholding']) ? $data['total_shareholding'] : null;
        $this->container['total_shareholding_percentage'] = isset($data['total_shareholding_percentage']) ? $data['total_shareholding_percentage'] : null;
        ...
        $this->container['not_matched'] = isset($data['not_matched']) ? $data['not_matched'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_shareholding'] === null) {
            $invalidProperties[] = "'total_shareholding' can't be null";
        }
        if ($this->container['total_shareholding_percentage'] === null) {
            $invalidProperties[] = "'total_shareholding_percentage' can't be null";
        }
        if ($this->container['shareholdings'] === null) {
            $invalidProperties[] = "'shareholdings' can't be null";
        }
        ...
        if ($this->container['not_matched'] === null) {
            $invalidProperties[] = "'not_matched' can't be null";
        }
    ...
    /**
     * Gets total_shareholding
     *
     * @return int
     */
    public function getTotalShareholding()
    {
        return $this->container['total_shareholding'];
    }

    /**
     * Sets total_shareholding
     *
     * @param int $total_shareholding total_shareholding
     *
     * @return $this
     */
    public function setTotalShareholding($total_shareholding)
    {
        $this->container['total_shareholding'] = $total_shareholding;

        return $this;
    }

    /**
     * Gets total_shareholding_percentage
     *
     * @return float
     */
    public function getTotalShareholdingPercentage()
    {
        return $this->container['total_shareholding_percentage'];
    }

    /**
     * Sets total_shareholding_percentage
     *
     * @param float $total_shareholding_percentage total_shareholding_percentage
     *
     * @return $this
     */
    public function setTotalShareholdingPercentage($total_shareholding_percentage)
    {
        $this->container['total_shareholding_percentage'] = $total_shareholding_percentage;
     ...
     * Gets shareholdings
     *
     * @return \Swagger\Client\Model\CompanyCheckResultsMatchedCompanyShareholdings[]
     */
     ...
     * Sets shareholdings
     *
     * @param \Swagger\Client\Model\CompanyCheckResultsMatchedCompanyShareholdings[] $shareholdings shareholdings
     *
     * @return $this
     */
     ...
     * Sets exact_matches
     *
     * @param object[] $exact_matches exact_matches
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\CompanyCheckPossibleMatch[]
     */
     ...
     *
     * @param \Swagger\Client\Model\CompanyCheckPossibleMatch[] $possible_matches possible_matches
     *
     * @return $this
     */
     ...
     * Gets not_matched
     *
     * @return \Swagger\Client\Model\SharedNotMatched
     */
    public function getNotMatched()
    {
        return $this->container['not_matched'];
    }

    /**
     * Sets not_matched
     *
     * @param \Swagger\Client\Model\SharedNotMatched $not_matched not_matched
     *
     * @return $this
     */
    public function setNotMatched($not_matched)
    {
        $this->container['not_matched'] = $not_matched;
