<?php
/**
 * CompanySearchCriteriaCriteriaIncorporated
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchCriteriaCriteriaIncorporated Class Doc Comment
 *
 * @category Class
 * @description Companies whose incorporation date falls within the given range
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchCriteriaCriteriaIncorporated implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanySearchCriteria_criteria_incorporated';
    ...
    protected static $swaggerTypes = [
        'from' => '\Swagger\Client\Model\CompanySearchCriteriaCriteriaIncorporatedFrom',
        'to' => '\Swagger\Client\Model\CompanySearchCriteriaCriteriaIncorporatedFrom'
    ];
     ...
     * Gets from
     *
     * @return \Swagger\Client\Model\CompanySearchCriteriaCriteriaIncorporatedFrom
     */
     ...
     * Sets from
     *
     * @param \Swagger\Client\Model\CompanySearchCriteriaCriteriaIncorporatedFrom $from from
     *
     * @return $this
     */
     ...
     * Sets to
     *
     * @param \Swagger\Client\Model\CompanySearchCriteriaCriteriaIncorporatedFrom $to to
     *
     * @return $this
     */
