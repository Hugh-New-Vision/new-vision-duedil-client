...
/**
 * FCAAuthorisationsPermissions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FCAAuthorisationsPermissions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FCAAuthorisations_permissions';
    ...
    protected static $setters = [
        'activity_category' => 'setActivityCategory',
    ...
    protected static $getters = [
        'activity_category' => 'getActivityCategory',
    ...
    {
        $this->container['activity_category'] = isset($data['activity_category']) ? $data['activity_category'] : null;
        $this->container['activity_description'] = isset($data['activity_description']) ? $data['activity_description'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['activity_category'] === null) {
            $invalidProperties[] = "'activity_category' can't be null";
        }
        if ($this->container['activity_description'] === null) {
            $invalidProperties[] = "'activity_description' can't be null";
        }
    ...
    /**
     * Gets activity_category
     *
     * @return string
     */
    public function getActivityCategory()
    {
        return $this->container['activity_category'];
    }

    /**
     * Sets activity_category
     *
     * @param string $activity_category activity_category
     *
     * @return $this
     */
    public function setActivityCategory($activity_category)
    {
        $this->container['activity_category'] = $activity_category;
     ...
     *
     * @param string $activity_description activity_description
     *
     * @return $this
     */
