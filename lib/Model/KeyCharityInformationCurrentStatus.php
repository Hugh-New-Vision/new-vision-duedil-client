<?php
/**
 * KeyCharityInformationCurrentStatus
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * KeyCharityInformationCurrentStatus Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeyCharityInformationCurrentStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeyCharityInformation_currentStatus';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reason_for_change'] = isset($data['reason_for_change']) ? $data['reason_for_change'] : null;
    }
     ...
     * Sets status
     *
     * @param string $status Jurisdiction-specific charity status
     *
     * @return $this
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date Status update date in ISO 8601 date format (YYYY-MM-DD)
     *
     * @return $this
     */
     ...
     *
     * @param string $reason_for_change Reason for change of the status
     *
     * @return $this
     */
