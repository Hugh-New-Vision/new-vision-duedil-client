...
/**
 * CompanyCheckResultsWarnings Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsWarnings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_warnings';
    ...
    const REASONS_NO_SHAREHOLDER_INFORMATION_WAS_FOUND = 'Warning: No shareholder information was found';
    const REASONS_NO_SHAREHOLDER_INFORMATION_WAS_FOUND_FOR_THE_ULTIMATE_PARENT = 'Warning: No shareholder information was found for the ultimate parent';
    const REASONS_ULTIMATE_PARENT_IS_A_FOREIGN_COMPANY = 'Warning: Ultimate parent is a foreign company';
    const REASONS_ANNUAL_RETURN_OR_CONFIRMATION_STATEMENT_IS_OVERDUE = 'Warning: Annual return or confirmation statement is overdue';
    const REASONS_ACCOUNTS_ARE_OVERDUE = 'Warning: Accounts are overdue';
    const REASONS_A_FORMER_OFFICER_IS_DISQUALIFIED = 'Warning: A former officer is disqualified';
    const REASONS_ONE_OR_MORE_GAZETTE_NOTICES_WERE_FOUND = 'Warning: One or more Gazette notices were found';
    const REASONS_COMPANY_STATUS_IS_INTERMEDIATE = 'Warning: Company status is Intermediate';
    const REASONS_PE_PS_AND_SANCTIONS_CHECK_RETURNED_ONE_OR_MORE_BUSINESSES_WITH_A_MATCH_SCORE_AT_OR_ABOVE_80 = 'Warning: PEPs and sanctions check returned one or more businesses with a match score at or above 80';
    ...
    {
        return [
            self::REASONS_NO_SHAREHOLDER_INFORMATION_WAS_FOUND,
            self::REASONS_NO_SHAREHOLDER_INFORMATION_WAS_FOUND_FOR_THE_ULTIMATE_PARENT,
            self::REASONS_ULTIMATE_PARENT_IS_A_FOREIGN_COMPANY,
            self::REASONS_ANNUAL_RETURN_OR_CONFIRMATION_STATEMENT_IS_OVERDUE,
            self::REASONS_ACCOUNTS_ARE_OVERDUE,
            self::REASONS_A_FORMER_OFFICER_IS_DISQUALIFIED,
            self::REASONS_ONE_OR_MORE_GAZETTE_NOTICES_WERE_FOUND,
            self::REASONS_COMPANY_STATUS_IS_INTERMEDIATE,
            self::REASONS_PE_PS_AND_SANCTIONS_CHECK_RETURNED_ONE_OR_MORE_BUSINESSES_WITH_A_MATCH_SCORE_AT_OR_ABOVE_80,
        ];
    }
     ...
     * Sets reasons
     *
     * @param string[] $reasons List of possible warnings.
     *
     * @return $this
     */
