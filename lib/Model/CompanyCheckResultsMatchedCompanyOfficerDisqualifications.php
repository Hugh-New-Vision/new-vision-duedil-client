<?php
/**
 * CompanyCheckResultsMatchedCompanyOfficerDisqualifications
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyOfficerDisqualifications Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyOfficerDisqualifications implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_officerDisqualifications';
    ...
    protected static $swaggerFormats = [
        'current_officer_disqualified' => null,
        'former_officer_disqualified' => null
    ];
    ...
    protected static $attributeMap = [
        'current_officer_disqualified' => 'currentOfficerDisqualified',
        'former_officer_disqualified' => 'formerOfficerDisqualified'
    ];
    ...
    protected static $setters = [
        'current_officer_disqualified' => 'setCurrentOfficerDisqualified',
        'former_officer_disqualified' => 'setFormerOfficerDisqualified'
    ];
    ...
    protected static $getters = [
        'current_officer_disqualified' => 'getCurrentOfficerDisqualified',
        'former_officer_disqualified' => 'getFormerOfficerDisqualified'
    ];
    ...
    {
        $this->container['current_officer_disqualified'] = isset($data['current_officer_disqualified']) ? $data['current_officer_disqualified'] : null;
        $this->container['former_officer_disqualified'] = isset($data['former_officer_disqualified']) ? $data['former_officer_disqualified'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['current_officer_disqualified'] === null) {
            $invalidProperties[] = "'current_officer_disqualified' can't be null";
        }
        if ($this->container['former_officer_disqualified'] === null) {
            $invalidProperties[] = "'former_officer_disqualified' can't be null";
        }
    ...
    /**
     * Gets current_officer_disqualified
     *
     * @return bool
     */
    public function getCurrentOfficerDisqualified()
    {
        return $this->container['current_officer_disqualified'];
    }

    /**
     * Sets current_officer_disqualified
     *
     * @param bool $current_officer_disqualified current_officer_disqualified
     *
     * @return $this
     */
    public function setCurrentOfficerDisqualified($current_officer_disqualified)
    {
        $this->container['current_officer_disqualified'] = $current_officer_disqualified;

        return $this;
    }

    /**
     * Gets former_officer_disqualified
     *
     * @return bool
     */
    public function getFormerOfficerDisqualified()
    {
        return $this->container['former_officer_disqualified'];
    }

    /**
     * Sets former_officer_disqualified
     *
     * @param bool $former_officer_disqualified former_officer_disqualified
     *
     * @return $this
     */
    public function setFormerOfficerDisqualified($former_officer_disqualified)
    {
        $this->container['former_officer_disqualified'] = $former_officer_disqualified;
