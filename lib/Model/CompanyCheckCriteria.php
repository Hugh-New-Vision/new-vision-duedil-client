...
/**
 * CompanyCheckCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckCriteria';
     ...
     * Sets company_id
     *
     * @param string $company_id Company registration number. **Required** if name is not provided
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Registered company name. **Required** if companyId is not provided
     *
     * @return $this
     */
