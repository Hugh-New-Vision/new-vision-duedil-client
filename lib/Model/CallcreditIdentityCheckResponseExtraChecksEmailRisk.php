...
/**
 * CallcreditIdentityCheckResponseExtraChecksEmailRisk Class Doc Comment
 *
 * @category Class
 * @description Contains information on the input email address and the fraud risk associated with it. For this report to be generated a valid email address needs to be provided in the Identity Details input.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksEmailRisk implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_emailRisk';
    ...
    protected static $swaggerTypes = [
        'warnings' => 'string[]',
        'report' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksEmailRiskReport'
    ];
     ...
     * Sets warnings
     *
     * @param string[] $warnings Any relevant warnings related to the Email Risk report. For example if the user has no access to this module the report will be NULL and that will be explained in a warning message.
     *
     * @return $this
     */
     ...
     * Gets report
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksEmailRiskReport
     */
     ...
     * Sets report
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksEmailRiskReport $report report
     *
     * @return $this
     */
