<?php
/**
 * RelatedCompaniesMutualMajorShareholders
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RelatedCompaniesMutualMajorShareholders Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RelatedCompaniesMutualMajorShareholders implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RelatedCompanies_mutualMajorShareholders';
     ...
     * Sets count
     *
     * @param int $count Number of mutual major shareholders between the source and destination companies
     *
     * @return $this
     */
