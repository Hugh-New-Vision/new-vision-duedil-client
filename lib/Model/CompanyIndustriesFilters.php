...
/**
 * CompanyIndustriesFilters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyIndustriesFilters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyIndustries_filters';
    ...
    const TYPES_SIC2003 = 'SIC2003';
    const TYPES_SIC2007 = 'SIC2007';
    const TYPES_NACE = 'NACE';
    const TYPES_NAF = 'NAF';
