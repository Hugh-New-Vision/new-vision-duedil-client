<?php
/**
 * CompanyCreditReportCreditReportCommentary
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCreditReportCreditReportCommentary Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCreditReportCreditReportCommentary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCreditReport_creditReport_commentary';
    ...
    const DIRECTION_POSITIVE = 'Positive';
    const DIRECTION_NEUTRAL = 'Neutral';
    const DIRECTION_NEGATIVE = 'Negative';
