<?php
/**
 * PEPsAndSanctionsAnyIndividualCriteria
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PEPsAndSanctionsAnyIndividualCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PEPsAndSanctionsAnyIndividualCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PEPsAndSanctionsAnyIndividualCriteria';
    ...
    protected static $setters = [
        'any_individual' => 'setAnyIndividual'
    ];
    ...
    protected static $getters = [
        'any_individual' => 'getAnyIndividual'
    ];
    ...
    {
        $this->container['any_individual'] = isset($data['any_individual']) ? $data['any_individual'] : null;
    }
     ...
     * @return object
     */
    public function getAnyIndividual()
    {
        return $this->container['any_individual'];
    }

    /**
     * Sets any_individual
     *
     * @param object $any_individual any_individual
     *
     * @return $this
     */
    public function setAnyIndividual($any_individual)
    {
        $this->container['any_individual'] = $any_individual;
