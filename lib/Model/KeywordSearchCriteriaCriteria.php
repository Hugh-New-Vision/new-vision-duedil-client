...
/**
 * KeywordSearchCriteriaCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordSearchCriteriaCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeywordSearchCriteria_criteria';
     ...
     * Sets keyword
     *
     * @param string $keyword Text contained in the desired keyword
     *
     * @return $this
     */
