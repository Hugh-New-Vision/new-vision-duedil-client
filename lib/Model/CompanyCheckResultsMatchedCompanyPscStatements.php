<?php
/**
 * CompanyCheckResultsMatchedCompanyPscStatements
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyPscStatements Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyPscStatements implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_pscStatements';
    ...
    {
        $this->container['filed_at'] = isset($data['filed_at']) ? $data['filed_at'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['filed_at'] === null) {
            $invalidProperties[] = "'filed_at' can't be null";
        }
        if ($this->container['ceased_at'] === null) {
            $invalidProperties[] = "'ceased_at' can't be null";
        }
    ...
    {
        return $this->container['filed_at'];
    }

    /**
     * Sets filed_at
     *
     * @param \DateTime $filed_at filed_at
     *
     * @return $this
     */
    public function setFiledAt($filed_at)
    {
        $this->container['filed_at'] = $filed_at;
     ...
     * Sets ceased_at
     *
     * @param \DateTime $ceased_at ceased_at
     *
     * @return $this
     */
