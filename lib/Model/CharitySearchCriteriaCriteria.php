...
/**
 * CharitySearchCriteriaCriteria Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CharitySearchCriteriaCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CharitySearchCriteria_criteria';
     ...
     * Sets name
     *
     * @param string $name Name of the desired charity
     *
     * @return $this
     */
