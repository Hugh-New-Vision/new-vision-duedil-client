<?php
/**
 * CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningCountries
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningCountries Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningCountries implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_watchlistScreening_countries';
    ...
    protected static $attributeMap = [
        ...
        'country_connection' => 'countryConnection'
    ];
    ...
    protected static $setters = [
        ...
        'country_connection' => 'setCountryConnection'
    ];
    ...
    protected static $getters = [
        ...
        'country_connection' => 'getCountryConnection'
    ];
    ...
    const COUNTRY_CONNECTION_CITIZENSHIP = 'Citizenship';
    const COUNTRY_CONNECTION_RESIDENT_OF = 'Resident of';
    const COUNTRY_CONNECTION_JURISDICTION = 'Jurisdiction';
     ...
     * @return string[]
     */
    public function getCountryConnectionAllowableValues()
    {
        return [
            self::COUNTRY_CONNECTION_CITIZENSHIP,
            self::COUNTRY_CONNECTION_RESIDENT_OF,
            self::COUNTRY_CONNECTION_JURISDICTION,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['country_connection'] = isset($data['country_connection']) ? $data['country_connection'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCountryConnectionAllowableValues();
        if (!is_null($this->container['country_connection']) && !in_array($this->container['country_connection'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'country_connection', must be one of '%s'",
     ...
     * Sets country_code
     *
     * @param string $country_code Country code returned in alpha-3 format as defined in ISO 3166-1 e.g. GBR
     *
     * @return $this
     */
    ...
    /**
     * Gets country_connection
     *
     * @return string
     */
    public function getCountryConnection()
    {
        return $this->container['country_connection'];
    }

    /**
     * Sets country_connection
     *
     * @param string $country_connection Connection of the match to the country
     *
     * @return $this
     */
    public function setCountryConnection($country_connection)
    {
        $allowedValues = $this->getCountryConnectionAllowableValues();
        if (!is_null($country_connection) && !in_array($country_connection, $allowedValues, true)) {
        ...
        $this->container['country_connection'] = $country_connection;
