...
/**
 * CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportVelocityData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportVelocityData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_realTimeFraudAlerts_report_velocityData';
    ...
    const TYPE_BANK_DETAILS = 'BankDetails';
    const TYPE_CARD_DETAILS = 'CardDetails';
    const TYPE_EMAIL_ADDRESS = 'EmailAddress';
    const TYPE_IP_ADDRESS = 'IPAddress';
    const TYPE_TELEPHONE_NUMBER = 'TelephoneNumber';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['times_seen'] = isset($data['times_seen']) ? $data['times_seen'] : null;
     ...
     * Sets type
     *
     * @param string $type The ‘Type’ attribute defines the Velocity data item that the results have been generated for. The ‘Type’ attribute can be one of the following below.
     *
     * @return $this
     */
     ...
     * Sets last_seen
     *
     * @param \DateTime $last_seen The date and time that the same input data was last seen, within the VelocityPeriod and Level* set in the configuration.
     *
     * @return $this
     */
    ...
    {
        return $this->container['times_seen'];
    }

    /**
     * Sets times_seen
     *
     * @param int $times_seen The number of times that the same input data has been seen, within the VelocityPeriod and Level* set in the configuration.
     *
     * @return $this
     */
    public function setTimesSeen($times_seen)
    {
        $this->container['times_seen'] = $times_seen;
     ...
     * Sets warning
     *
     * @param bool $warning If the TimesSeen exceeds the VelocityThreshold set in the configuration this will be ‘true’, otherwise ‘false’.
     *
     * @return $this
     */
