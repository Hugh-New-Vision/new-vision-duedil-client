<?php
/**
 * CompanyTelephoneNumbersAddress
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyTelephoneNumbersAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyTelephoneNumbersAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyTelephoneNumbers_address';
    ...
    protected static $swaggerTypes = [
        'full_address' => 'string',
        'structured_address' => '\Swagger\Client\Model\StructuredAddress',
        'geolocation' => '\Swagger\Client\Model\GeoLocation'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['structured_address'] = isset($data['structured_address']) ? $data['structured_address'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['structured_address'] === null) {
            $invalidProperties[] = "'structured_address' can't be null";
        }
     ...
     * Sets full_address
     *
     * @param string $full_address A ready-to-render single-line string representation of an address.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\StructuredAddress
     */
     ...
     *
     * @param \Swagger\Client\Model\StructuredAddress $structured_address structured_address
     *
     * @return $this
     */
     ...
     * Sets geolocation
     *
     * @param \Swagger\Client\Model\GeoLocation $geolocation geolocation
     *
     * @return $this
     */
