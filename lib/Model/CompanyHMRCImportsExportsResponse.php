<?php
/**
 * CompanyHMRCImportsExportsResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyHMRCImportsExportsResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyHMRCImportsExportsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyHMRCImportsExportsResponse';
    ...
    protected static $swaggerTypes = [
        'country_code' => 'string',
        'company_id' => 'string',
        'pagination' => '\Swagger\Client\Model\PaginationPagination',
        'hmrc_imports_and_exports' => '\Swagger\Client\Model\HMRCImportsExportsHmrcImportsAndExports[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'hmrc_imports_and_exports' => 'hmrcImportsAndExports'
    ];
    ...
    protected static $setters = [
        ...
        'hmrc_imports_and_exports' => 'setHmrcImportsAndExports'
    ];
    ...
    protected static $getters = [
        ...
        'hmrc_imports_and_exports' => 'getHmrcImportsAndExports'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hmrc_imports_and_exports'] = isset($data['hmrc_imports_and_exports']) ? $data['hmrc_imports_and_exports'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hmrc_imports_and_exports'] === null) {
            $invalidProperties[] = "'hmrc_imports_and_exports' can't be null";
        }
     ...
     * Gets pagination
     *
     * @return \Swagger\Client\Model\PaginationPagination
     */
     ...
     * Sets pagination
     *
     * @param \Swagger\Client\Model\PaginationPagination $pagination pagination
     *
     * @return $this
     */
    ...
    /**
     * Gets hmrc_imports_and_exports
     *
     * @return \Swagger\Client\Model\HMRCImportsExportsHmrcImportsAndExports[]
     */
    public function getHmrcImportsAndExports()
    {
        return $this->container['hmrc_imports_and_exports'];
    }

    /**
     * Sets hmrc_imports_and_exports
     *
     * @param \Swagger\Client\Model\HMRCImportsExportsHmrcImportsAndExports[] $hmrc_imports_and_exports hmrc_imports_and_exports
     *
     * @return $this
     */
    public function setHmrcImportsAndExports($hmrc_imports_and_exports)
    {
        $this->container['hmrc_imports_and_exports'] = $hmrc_imports_and_exports;
