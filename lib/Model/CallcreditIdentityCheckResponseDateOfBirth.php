...
/**
 * CallcreditIdentityCheckResponseDateOfBirth Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseDateOfBirth implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_dateOfBirth';
    ...
    protected static $swaggerFormats = [
        'dob_confirmed_records' => null,
        'dob_total_records' => null,
        'dob_level_of_confidence' => null
    ];
    ...
    protected static $attributeMap = [
        'dob_confirmed_records' => 'dobConfirmedRecords',
        'dob_total_records' => 'dobTotalRecords',
        'dob_level_of_confidence' => 'dobLevelOfConfidence'
    ];
    ...
    protected static $setters = [
        'dob_confirmed_records' => 'setDobConfirmedRecords',
        'dob_total_records' => 'setDobTotalRecords',
        'dob_level_of_confidence' => 'setDobLevelOfConfidence'
    ];
    ...
    protected static $getters = [
        'dob_confirmed_records' => 'getDobConfirmedRecords',
        'dob_total_records' => 'getDobTotalRecords',
        'dob_level_of_confidence' => 'getDobLevelOfConfidence'
    ];
    ...
    {
        $this->container['dob_confirmed_records'] = isset($data['dob_confirmed_records']) ? $data['dob_confirmed_records'] : null;
        $this->container['dob_total_records'] = isset($data['dob_total_records']) ? $data['dob_total_records'] : null;
        $this->container['dob_level_of_confidence'] = isset($data['dob_level_of_confidence']) ? $data['dob_level_of_confidence'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dob_confirmed_records'] === null) {
            $invalidProperties[] = "'dob_confirmed_records' can't be null";
        }
        if ($this->container['dob_total_records'] === null) {
            $invalidProperties[] = "'dob_total_records' can't be null";
        }
        if ($this->container['dob_level_of_confidence'] === null) {
            $invalidProperties[] = "'dob_level_of_confidence' can't be null";
        }
    ...
    /**
     * Gets dob_confirmed_records
     *
     * @return int
     */
    public function getDobConfirmedRecords()
    {
        return $this->container['dob_confirmed_records'];
    }

    /**
     * Sets dob_confirmed_records
     *
     * @param int $dob_confirmed_records Number of dates of birth confirmed against Callcredit's SHARE records used in the decision
     *
     * @return $this
     */
    public function setDobConfirmedRecords($dob_confirmed_records)
    {
        $this->container['dob_confirmed_records'] = $dob_confirmed_records;

        return $this;
    }

    /**
     * Gets dob_total_records
     *
     * @return int
     */
    public function getDobTotalRecords()
    {
        return $this->container['dob_total_records'];
    }

    /**
     * Sets dob_total_records
     *
     * @param int $dob_total_records dob_total_records
     *
     * @return $this
     */
    public function setDobTotalRecords($dob_total_records)
    {
        $this->container['dob_total_records'] = $dob_total_records;

        return $this;
    }

    /**
     * Gets dob_level_of_confidence
     *
     * @return int
     */
    public function getDobLevelOfConfidence()
    {
        return $this->container['dob_level_of_confidence'];
    }

    /**
     * Sets dob_level_of_confidence
     *
     * @param int $dob_level_of_confidence dob_level_of_confidence
     *
     * @return $this
     */
    public function setDobLevelOfConfidence($dob_level_of_confidence)
    {
        $this->container['dob_level_of_confidence'] = $dob_level_of_confidence;
