<?php
/**
 * RelatedCompaniesMutualOfficers
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RelatedCompaniesMutualOfficers Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RelatedCompaniesMutualOfficers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RelatedCompanies_mutualOfficers';
     ...
     * Sets count
     *
     * @param int $count Number of mutual officers between the source and destination companies
     *
     * @return $this
     */
