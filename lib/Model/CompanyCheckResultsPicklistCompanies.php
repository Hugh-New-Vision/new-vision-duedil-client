<?php
/**
 * CompanyCheckResultsPicklistCompanies
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsPicklistCompanies Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsPicklistCompanies implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_picklistCompanies';
     ...
     *
     * @param string $registered_address registered_address
     *
     * @return $this
     */
