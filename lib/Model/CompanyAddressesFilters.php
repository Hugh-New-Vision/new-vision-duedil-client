...
/**
 * CompanyAddressesFilters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyAddressesFilters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyAddresses_filters';
    ...
    const TYPES_TRADING = 'trading';
    const TYPES_BRANCH = 'branch';
