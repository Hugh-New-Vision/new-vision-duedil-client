...
/**
 * CallcreditIdentityCheckResponseExtraChecks Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks';
    ...
    protected static $swaggerTypes = [
        'email_risk' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksEmailRisk',
        'real_time_fraud_alerts' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts',
        'watchlist_screening' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksWatchlistScreening'
    ];
    ...
    protected static $attributeMap = [
        ...
        'real_time_fraud_alerts' => 'realTimeFraudAlerts',
    ...
    protected static $setters = [
        'email_risk' => 'setEmailRisk',
        'real_time_fraud_alerts' => 'setRealTimeFraudAlerts',
        'watchlist_screening' => 'setWatchlistScreening'
    ];
    ...
    protected static $getters = [
        'email_risk' => 'getEmailRisk',
        'real_time_fraud_alerts' => 'getRealTimeFraudAlerts',
        'watchlist_screening' => 'getWatchlistScreening'
    ];
    ...
    {
        $this->container['email_risk'] = isset($data['email_risk']) ? $data['email_risk'] : null;
        $this->container['real_time_fraud_alerts'] = isset($data['real_time_fraud_alerts']) ? $data['real_time_fraud_alerts'] : null;
        $this->container['watchlist_screening'] = isset($data['watchlist_screening']) ? $data['watchlist_screening'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_risk'] === null) {
            $invalidProperties[] = "'email_risk' can't be null";
        }
        if ($this->container['real_time_fraud_alerts'] === null) {
            $invalidProperties[] = "'real_time_fraud_alerts' can't be null";
        }
        if ($this->container['watchlist_screening'] === null) {
            $invalidProperties[] = "'watchlist_screening' can't be null";
        }
     ...
     * Gets email_risk
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksEmailRisk
     */
    public function getEmailRisk()
    {
        return $this->container['email_risk'];
    }

    /**
     * Sets email_risk
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksEmailRisk $email_risk email_risk
     *
     * @return $this
     */
    public function setEmailRisk($email_risk)
    {
        $this->container['email_risk'] = $email_risk;

        return $this;
    }

    /**
     * Gets real_time_fraud_alerts
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts
     */
    public function getRealTimeFraudAlerts()
    {
        return $this->container['real_time_fraud_alerts'];
    }

    /**
     * Sets real_time_fraud_alerts
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts $real_time_fraud_alerts real_time_fraud_alerts
     *
     * @return $this
     */
    public function setRealTimeFraudAlerts($real_time_fraud_alerts)
    {
        $this->container['real_time_fraud_alerts'] = $real_time_fraud_alerts;

        return $this;
    }

    /**
     * Gets watchlist_screening
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksWatchlistScreening
     */
    public function getWatchlistScreening()
    {
        return $this->container['watchlist_screening'];
    }

    /**
     * Sets watchlist_screening
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksWatchlistScreening $watchlist_screening watchlist_screening
     *
     * @return $this
     */
    public function setWatchlistScreening($watchlist_screening)
    {
        $this->container['watchlist_screening'] = $watchlist_screening;
