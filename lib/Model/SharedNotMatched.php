...
/**
 * SharedNotMatched Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SharedNotMatched implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SharedNotMatched';
    ...
    protected static $setters = [
        'suspected_type' => 'setSuspectedType'
    ];
    ...
    protected static $getters = [
        'suspected_type' => 'getSuspectedType'
    ];
    ...
    const SUSPECTED_TYPE_PERSON = 'person';
    const SUSPECTED_TYPE_COMPANY = 'company';
     ...
     * @return string[]
     */
    public function getSuspectedTypeAllowableValues()
    {
        return [
            self::SUSPECTED_TYPE_PERSON,
            self::SUSPECTED_TYPE_COMPANY,
        ];
    }
    ...
    {
        $this->container['suspected_type'] = isset($data['suspected_type']) ? $data['suspected_type'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['suspected_type'] === null) {
            $invalidProperties[] = "'suspected_type' can't be null";
        }
        $allowedValues = $this->getSuspectedTypeAllowableValues();
        if (!is_null($this->container['suspected_type']) && !in_array($this->container['suspected_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'suspected_type', must be one of '%s'",
     ...
     * @return string
     */
    public function getSuspectedType()
    {
        return $this->container['suspected_type'];
    }

    /**
     * Sets suspected_type
     *
     * @param string $suspected_type suspected_type
     *
     * @return $this
     */
    public function setSuspectedType($suspected_type)
    {
        $allowedValues = $this->getSuspectedTypeAllowableValues();
        if (!in_array($suspected_type, $allowedValues, true)) {
        ...
        $this->container['suspected_type'] = $suspected_type;
