<?php
/**
 * CompanyCreditReportCreditReportCreditRatingCreditScore
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCreditReportCreditReportCreditRatingCreditScore Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCreditReportCreditReportCreditRatingCreditScore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCreditReport_creditReport_creditRating_creditScore';
    ...
    protected static $attributeMap = [
        ...
        'value_last_change' => 'valueLastChange'
    ];
    ...
    protected static $setters = [
        ...
        'value_last_change' => 'setValueLastChange'
    ];
    ...
    protected static $getters = [
        ...
        'value_last_change' => 'getValueLastChange'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['value_last_change'] = isset($data['value_last_change']) ? $data['value_last_change'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['range_min'] === null) {
            $invalidProperties[] = "'range_min' can't be null";
        }
        if ($this->container['range_max'] === null) {
            $invalidProperties[] = "'range_max' can't be null";
        }
        if ($this->container['description'] === null) {
            $invalidProperties[] = "'description' can't be null";
        }
        if ($this->container['value_last_change'] === null) {
            $invalidProperties[] = "'value_last_change' can't be null";
        }
     ...
     * Sets range_min
     *
     * @param float $range_min range_min
     *
     * @return $this
     */
     ...
     * Sets range_max
     *
     * @param float $range_max range_max
     *
     * @return $this
     */
    ...
    /**
     * Gets value_last_change
     *
     * @return float
     */
    public function getValueLastChange()
    {
        return $this->container['value_last_change'];
    }

    /**
     * Sets value_last_change
     *
     * @param float $value_last_change value_last_change
     *
     * @return $this
     */
    public function setValueLastChange($value_last_change)
    {
        $this->container['value_last_change'] = $value_last_change;
