...
/**
 * RegionsMultiValueFilterValues Class Doc Comment
 *
 * @category Class
 * @description An array of objects detailing the desired regionId and the types of addresses to include
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegionsMultiValueFilterValues implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionsMultiValueFilter_values';
    ...
    const ADDRESS_TYPES_REGISTERED = 'registered';
    const ADDRESS_TYPES_TRADING = 'trading';
    const ADDRESS_TYPES_BRANCH = 'branch';
    ...
    {
        return [
            self::ADDRESS_TYPES_REGISTERED,
            self::ADDRESS_TYPES_TRADING,
            self::ADDRESS_TYPES_BRANCH,
        ];
    }
     ...
     * Sets region_id
     *
     * @param string $region_id Region ID (Can be obtained using the 'regions search' endpoint)
     *
     * @return $this
     */
     ...
     * Sets address_types
     *
     * @param string[] $address_types Company address usage types
     *
     * @return $this
     */
