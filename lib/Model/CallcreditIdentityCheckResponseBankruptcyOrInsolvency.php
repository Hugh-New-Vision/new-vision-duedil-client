...
/**
 * CallcreditIdentityCheckResponseBankruptcyOrInsolvency Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseBankruptcyOrInsolvency implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_bankruptcyOrInsolvency';
    ...
    protected static $swaggerFormats = [
        'bai_record_count' => null,
        'bai_level_of_confidence' => null
    ];
    ...
    protected static $attributeMap = [
        'bai_record_count' => 'baiRecordCount',
        'bai_level_of_confidence' => 'baiLevelOfConfidence'
    ];
    ...
    protected static $setters = [
        'bai_record_count' => 'setBaiRecordCount',
        'bai_level_of_confidence' => 'setBaiLevelOfConfidence'
    ];
    ...
    protected static $getters = [
        'bai_record_count' => 'getBaiRecordCount',
        'bai_level_of_confidence' => 'getBaiLevelOfConfidence'
    ];
    ...
    {
        $this->container['bai_record_count'] = isset($data['bai_record_count']) ? $data['bai_record_count'] : null;
        $this->container['bai_level_of_confidence'] = isset($data['bai_level_of_confidence']) ? $data['bai_level_of_confidence'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bai_record_count'] === null) {
            $invalidProperties[] = "'bai_record_count' can't be null";
        }
        if ($this->container['bai_level_of_confidence'] === null) {
            $invalidProperties[] = "'bai_level_of_confidence' can't be null";
        }
    ...
    /**
     * Gets bai_record_count
     *
     * @return int
     */
    public function getBaiRecordCount()
    {
        return $this->container['bai_record_count'];
    }

    /**
     * Sets bai_record_count
     *
     * @param int $bai_record_count bai_record_count
     *
     * @return $this
     */
    public function setBaiRecordCount($bai_record_count)
    {
        $this->container['bai_record_count'] = $bai_record_count;

        return $this;
    }

    /**
     * Gets bai_level_of_confidence
     *
     * @return int
     */
    public function getBaiLevelOfConfidence()
    {
        return $this->container['bai_level_of_confidence'];
    }

    /**
     * Sets bai_level_of_confidence
     *
     * @param int $bai_level_of_confidence bai_level_of_confidence
     *
     * @return $this
     */
    public function setBaiLevelOfConfidence($bai_level_of_confidence)
    {
        $this->container['bai_level_of_confidence'] = $bai_level_of_confidence;
