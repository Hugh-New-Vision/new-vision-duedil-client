...
/**
 * CompanyCheckResultsKybResult Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsKybResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_kybResult';
    ...
    const REASONS_FAILURE_A_CURRENT_OFFICER_IS_DISQUALIFIED = 'Failure: A current officer is disqualified';
    const REASONS_FAILURE_COMPANY_MATCHED_HAS_NO_DATA = 'Failure: Company matched has no data';
    const REASONS_FAILURE_COMPANY_STATUS_IS_CLOSED = 'Failure: Company status is Closed';
    const REASONS_FAILURE_COMPANY_STATUS_IS_DISSOLVED = 'Failure: Company status is Dissolved';
    const REASONS_FAILURE_COMPANY_STATUS_IS_NOT_ACTIVE = 'Failure: Company status is not Active';
    const REASONS_FAILURE_NO_COMPANY_WAS_MATCHED = 'Failure: No company was matched';
    const REASONS_FAILURE_ONE_OR_MORE_GAZETTE_NOTICES_WERE_FOUND = 'Failure: One or more Gazette notices were found';
    const REASONS_FAILURE_PE_PS_AND_SANCTIONS_CHECK_RETURNED_ONE_OR_MORE_BUSINESSES_WITH_A_MATCH_SCORE_OF_100 = 'Failure: PEPs and sanctions check returned one or more businesses with a match score of 100';
    const REASONS_FAILURE_PE_PS_AND_SANCTIONS_CHECK_UNAVAILABLE = 'Failure: PEPs and sanctions check unavailable';
    const REASONS_PICKLIST_SEVERAL_COMPANIES_MATCH_YOUR_CRITERIA = 'Picklist: Several companies match your criteria';
    ...
    {
        return [
            self::REASONS_FAILURE_A_CURRENT_OFFICER_IS_DISQUALIFIED,
            self::REASONS_FAILURE_COMPANY_MATCHED_HAS_NO_DATA,
            self::REASONS_FAILURE_COMPANY_STATUS_IS_CLOSED,
            self::REASONS_FAILURE_COMPANY_STATUS_IS_DISSOLVED,
            self::REASONS_FAILURE_COMPANY_STATUS_IS_NOT_ACTIVE,
            self::REASONS_FAILURE_NO_COMPANY_WAS_MATCHED,
            self::REASONS_FAILURE_ONE_OR_MORE_GAZETTE_NOTICES_WERE_FOUND,
            self::REASONS_FAILURE_PE_PS_AND_SANCTIONS_CHECK_RETURNED_ONE_OR_MORE_BUSINESSES_WITH_A_MATCH_SCORE_OF_100,
            self::REASONS_FAILURE_PE_PS_AND_SANCTIONS_CHECK_UNAVAILABLE,
            self::REASONS_PICKLIST_SEVERAL_COMPANIES_MATCH_YOUR_CRITERIA,
        ];
    }
     ...
     * Sets reasons
     *
     * @param string[] $reasons List of possible reasons for a FAIL score.
     *
     * @return $this
     */
