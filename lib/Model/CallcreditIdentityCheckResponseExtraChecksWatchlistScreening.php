...
/**
 * CallcreditIdentityCheckResponseExtraChecksWatchlistScreening Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksWatchlistScreening implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_watchlistScreening';
    ...
    protected static $swaggerTypes = [
        'count_of_peps' => 'int',
        'count_of_sanctions' => 'int',
        'count_of_rc_as' => 'int',
        'watchlist_screening_warning' => 'bool',
        'matches' => '\Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningMatches[]'
    ];
    ...
    protected static $swaggerFormats = [
        'count_of_peps' => null,
        'count_of_sanctions' => null,
        'count_of_rc_as' => null,
        'watchlist_screening_warning' => null,
        'matches' => null
    ];
    ...
    protected static $attributeMap = [
        'count_of_peps' => 'countOfPeps',
        'count_of_sanctions' => 'countOfSanctions',
        'count_of_rc_as' => 'countOfRCAs',
        'watchlist_screening_warning' => 'watchlistScreeningWarning',
        'matches' => 'matches'
    ];
    ...
    protected static $setters = [
        'count_of_peps' => 'setCountOfPeps',
        'count_of_sanctions' => 'setCountOfSanctions',
        'count_of_rc_as' => 'setCountOfRcAs',
        'watchlist_screening_warning' => 'setWatchlistScreeningWarning',
        'matches' => 'setMatches'
    ];
    ...
    protected static $getters = [
        'count_of_peps' => 'getCountOfPeps',
        'count_of_sanctions' => 'getCountOfSanctions',
        'count_of_rc_as' => 'getCountOfRcAs',
        'watchlist_screening_warning' => 'getWatchlistScreeningWarning',
        'matches' => 'getMatches'
    ];
    ...
    {
        $this->container['count_of_peps'] = isset($data['count_of_peps']) ? $data['count_of_peps'] : null;
        $this->container['count_of_sanctions'] = isset($data['count_of_sanctions']) ? $data['count_of_sanctions'] : null;
        $this->container['count_of_rc_as'] = isset($data['count_of_rc_as']) ? $data['count_of_rc_as'] : null;
        $this->container['watchlist_screening_warning'] = isset($data['watchlist_screening_warning']) ? $data['watchlist_screening_warning'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['count_of_peps'] === null) {
            $invalidProperties[] = "'count_of_peps' can't be null";
        }
        if ($this->container['count_of_sanctions'] === null) {
            $invalidProperties[] = "'count_of_sanctions' can't be null";
        }
        if ($this->container['count_of_rc_as'] === null) {
            $invalidProperties[] = "'count_of_rc_as' can't be null";
        }
     ...
     * @return int
     */
    public function getCountOfPeps()
    {
        return $this->container['count_of_peps'];
    }

    /**
     * Sets count_of_peps
     *
     * @param int $count_of_peps Count of potential matches where risk indicator = PEP (Politically Exposed Person)
     *
     * @return $this
     */
    public function setCountOfPeps($count_of_peps)
    {
        $this->container['count_of_peps'] = $count_of_peps;

        return $this;
    }

    /**
     * Gets count_of_sanctions
     *
     * @return int
     */
    public function getCountOfSanctions()
    {
        return $this->container['count_of_sanctions'];
    }

    /**
     * Sets count_of_sanctions
     *
     * @param int $count_of_sanctions Count of potential matches where risk indicator = RCA (Relative or Close Associate)
     *
     * @return $this
     */
    public function setCountOfSanctions($count_of_sanctions)
    {
        $this->container['count_of_sanctions'] = $count_of_sanctions;
     ...
     * @return int
     */
    public function getCountOfRcAs()
    {
        return $this->container['count_of_rc_as'];
    }

    /**
     * Sets count_of_rc_as
     *
     * @param int $count_of_rc_as Count of potential matches where risk indicator = Sanction (Individual has a sanction against them)
     *
     * @return $this
     */
    public function setCountOfRcAs($count_of_rc_as)
    {
        $this->container['count_of_rc_as'] = $count_of_rc_as;

        return $this;
    }

    /**
     * Gets watchlist_screening_warning
     *
     * @return bool
     */
    public function getWatchlistScreeningWarning()
    {
        return $this->container['watchlist_screening_warning'];
    }

    /**
     * Sets watchlist_screening_warning
     *
     * @param bool $watchlist_screening_warning True if any of the risk indicators counts above are greater than zero
     *
     * @return $this
     */
    public function setWatchlistScreeningWarning($watchlist_screening_warning)
    {
        $this->container['watchlist_screening_warning'] = $watchlist_screening_warning;
     ...
     * Gets matches
     *
     * @return \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningMatches[]
     */
     ...
     * Sets matches
     *
     * @param \Swagger\Client\Model\CallcreditIdentityCheckResponseExtraChecksWatchlistScreeningMatches[] $matches Matched records
     *
     * @return $this
     */
