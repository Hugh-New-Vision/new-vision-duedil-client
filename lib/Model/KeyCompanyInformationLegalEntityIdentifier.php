<?php
/**
 * KeyCompanyInformationLegalEntityIdentifier
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * KeyCompanyInformationLegalEntityIdentifier Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeyCompanyInformationLegalEntityIdentifier implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeyCompanyInformation_legalEntityIdentifier';
    ...
    {
        $this->container['lei'] = isset($data['lei']) ? $data['lei'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lei'] === null) {
            $invalidProperties[] = "'lei' can't be null";
        }
     ...
     * Sets lei
     *
     * @param string $lei Legal Entity Identifier (https://gleif.org) A global unique identifier for legal entities.
     *
     * @return $this
     */
     ...
     * Sets source_url
     *
     * @param string $source_url URL to the official gleif page for this LEI registration.
     *
     * @return $this
     */
