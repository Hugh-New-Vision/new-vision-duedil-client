<?php
/**
 * CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCreditReport_creditReport_paymentStatistics_invoicesPaid_beforeThreshold';
    ...
    protected static $setters = [
        'number' => 'setNumber',
        'percentage_of_total' => 'setPercentageOfTotal'
    ];
    ...
    protected static $getters = [
        'number' => 'getNumber',
        'percentage_of_total' => 'getPercentageOfTotal'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['percentage_of_total'] = isset($data['percentage_of_total']) ? $data['percentage_of_total'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['percentage_of_total'] === null) {
            $invalidProperties[] = "'percentage_of_total' can't be null";
        }
    ...
    /**
     * Gets percentage_of_total
     *
     * @return float
     */
    public function getPercentageOfTotal()
    {
        return $this->container['percentage_of_total'];
    }

    /**
     * Sets percentage_of_total
     *
     * @param float $percentage_of_total percentage_of_total
     *
     * @return $this
     */
    public function setPercentageOfTotal($percentage_of_total)
    {
        $this->container['percentage_of_total'] = $percentage_of_total;
