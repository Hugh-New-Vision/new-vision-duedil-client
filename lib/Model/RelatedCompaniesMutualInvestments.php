<?php
/**
 * RelatedCompaniesMutualInvestments
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RelatedCompaniesMutualInvestments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RelatedCompaniesMutualInvestments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RelatedCompanies_mutualInvestments';
     ...
     * Sets count
     *
     * @param int $count Number of mutual investments between the source and destination companies
     *
     * @return $this
     */
