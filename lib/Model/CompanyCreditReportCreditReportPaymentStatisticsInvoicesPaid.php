<?php
/**
 * CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCreditReport_creditReport_paymentStatistics_invoicesPaid';
    ...
    protected static $swaggerTypes = [
        'before_threshold' => '\Swagger\Client\Model\CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold',
        'after_threshold' => '\Swagger\Client\Model\CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold'
    ];
    ...
    protected static $setters = [
        'before_threshold' => 'setBeforeThreshold',
        'after_threshold' => 'setAfterThreshold'
    ];
    ...
    protected static $getters = [
        'before_threshold' => 'getBeforeThreshold',
        'after_threshold' => 'getAfterThreshold'
    ];
    ...
    {
        $this->container['before_threshold'] = isset($data['before_threshold']) ? $data['before_threshold'] : null;
        $this->container['after_threshold'] = isset($data['after_threshold']) ? $data['after_threshold'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['before_threshold'] === null) {
            $invalidProperties[] = "'before_threshold' can't be null";
        }
        if ($this->container['after_threshold'] === null) {
            $invalidProperties[] = "'after_threshold' can't be null";
        }
    ...
    /**
     * Gets before_threshold
     *
     * @return \Swagger\Client\Model\CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold
     */
    public function getBeforeThreshold()
    {
        return $this->container['before_threshold'];
    }

    /**
     * Sets before_threshold
     *
     * @param \Swagger\Client\Model\CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold $before_threshold before_threshold
     *
     * @return $this
     */
    public function setBeforeThreshold($before_threshold)
    {
        $this->container['before_threshold'] = $before_threshold;

        return $this;
    }

    /**
     * Gets after_threshold
     *
     * @return \Swagger\Client\Model\CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold
     */
    public function getAfterThreshold()
    {
        return $this->container['after_threshold'];
    }

    /**
     * Sets after_threshold
     *
     * @param \Swagger\Client\Model\CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold $after_threshold after_threshold
     *
     * @return $this
     */
    public function setAfterThreshold($after_threshold)
    {
        $this->container['after_threshold'] = $after_threshold;
