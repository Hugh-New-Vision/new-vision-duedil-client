<?php
/**
 * CompanyTelephoneNumbersResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyTelephoneNumbersResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyTelephoneNumbersResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyTelephoneNumbersResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'telephone_numbers' => '\Swagger\Client\Model\CompanyTelephoneNumbersTelephoneNumbers[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['telephone_numbers'] === null) {
            $invalidProperties[] = "'telephone_numbers' can't be null";
        }
     ...
     *
     * @return \Swagger\Client\Model\CompanyTelephoneNumbersTelephoneNumbers[]
     */
     ...
     *
     * @param \Swagger\Client\Model\CompanyTelephoneNumbersTelephoneNumbers[] $telephone_numbers telephone_numbers
     *
     * @return $this
     */
