<?php
/**
 * OfficerSearchResultsFiltersDateOfBirth
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OfficerSearchResultsFiltersDateOfBirth Class Doc Comment
 *
 * @category Class
 * @description Optional officer date of birth range issued in the search request
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OfficerSearchResultsFiltersDateOfBirth implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OfficerSearchResults_filters_dateOfBirth';
    ...
    protected static $swaggerTypes = [
        'from' => '\Swagger\Client\Model\OfficerSearchCriteriaCriteriaDateOfBirthFrom',
        'to' => '\Swagger\Client\Model\OfficerSearchCriteriaCriteriaDateOfBirthFrom'
    ];
     ...
     * Gets from
     *
     * @return \Swagger\Client\Model\OfficerSearchCriteriaCriteriaDateOfBirthFrom
     */
     ...
     * Sets from
     *
     * @param \Swagger\Client\Model\OfficerSearchCriteriaCriteriaDateOfBirthFrom $from from
     *
     * @return $this
     */
     ...
     * Sets to
     *
     * @param \Swagger\Client\Model\OfficerSearchCriteriaCriteriaDateOfBirthFrom $to to
     *
     * @return $this
     */
