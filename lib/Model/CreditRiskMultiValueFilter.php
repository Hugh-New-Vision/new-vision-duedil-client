...
/**
 * CreditRiskMultiValueFilter Class Doc Comment
 *
 * @category Class
 * @description List of credit risk bands.  **Note:** Access is restricted to keys with the [Credit Report](#tag/Credit-report) package.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreditRiskMultiValueFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreditRiskMultiValueFilter';
    ...
    protected static $swaggerTypes = [
        'values' => '\Swagger\Client\Model\CompanyCreditRisk[]'
    ];
     ...
     * Gets values
     *
     * @return \Swagger\Client\Model\CompanyCreditRisk[]
     */
     ...
     * Sets values
     *
     * @param \Swagger\Client\Model\CompanyCreditRisk[] $values values
     *
     * @return $this
     */
