<?php
/**
 * CompanyCharitableIdentitiesCharitableIdentities
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCharitableIdentitiesCharitableIdentities Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCharitableIdentitiesCharitableIdentities implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCharitableIdentities_charitableIdentities';
    ...
    protected static $swaggerTypes = [
        'charity_identification' => '\Swagger\Client\Model\CharityIdentification',
        'name' => 'string'
    ];
    ...
    protected static $attributeMap = [
        'charity_identification' => 'charityIdentification',
        'name' => 'name'
    ];
    ...
    protected static $setters = [
        'charity_identification' => 'setCharityIdentification',
        'name' => 'setName'
    ];
    ...
    protected static $getters = [
        'charity_identification' => 'getCharityIdentification',
        'name' => 'getName'
    ];
    ...
    {
        $this->container['charity_identification'] = isset($data['charity_identification']) ? $data['charity_identification'] : null;
    ...
    /**
     * Gets charity_identification
     *
     * @return \Swagger\Client\Model\CharityIdentification
     */
    public function getCharityIdentification()
    {
        return $this->container['charity_identification'];
    }

    /**
     * Sets charity_identification
     *
     * @param \Swagger\Client\Model\CharityIdentification $charity_identification charity_identification
     *
     * @return $this
     */
    public function setCharityIdentification($charity_identification)
    {
        $this->container['charity_identification'] = $charity_identification;
