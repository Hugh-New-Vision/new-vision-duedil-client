...
/**
 * KeywordSearchResultsFilters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordSearchResultsFilters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeywordSearchResults_filters';
     ...
     * Sets keyword
     *
     * @param string $keyword Keyword partial issued in the search request
     *
     * @return $this
     */
