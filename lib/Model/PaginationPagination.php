...
/**
 * PaginationPagination Class Doc Comment
 *
 * @category Class
 * @description Pagination information for the relevant collection
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginationPagination implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Pagination_pagination';
     ...
     * Sets offset
     *
     * @param int $offset 0-based offset corresponding to the the first element of the collection to be returned
     *
     * @return $this
     */
     ...
     * Sets limit
     *
     * @param int $limit Maximum number of elements from the collection to be returned in the response
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total Total number of items in the collection (after applying any specified filters)
     *
     * @return $this
     */
