...
/**
 * CallcreditIdentityCheckResponseExtraChecksEmailRiskReportDomain Class Doc Comment
 *
 * @category Class
 * @description Contains information on the current status and age of the email domain
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseExtraChecksEmailRiskReportDomain implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallcreditIdentityCheckResponse_extraChecks_emailRisk_report_domain';
     ...
     * Sets status
     *
     * @param string $status Current status of the email domain   Active - Email domain is currently active  Inactive - Email domain is currently not active  Expired - Email domain was previously active but not currently  Unknown - Unable to determine email domain status
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $registration_date The date which the email domain was first registered
     *
     * @return $this
     */
