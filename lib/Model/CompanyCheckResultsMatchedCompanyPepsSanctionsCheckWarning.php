<?php
/**
 * CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyCheckResults_matchedCompany_pepsSanctionsCheck_warning';
    ...
    protected static $swaggerFormats = [
        'threshold_match_score' => null,
        'matches_triggering_warning' => null
    ];
    ...
    protected static $attributeMap = [
        'threshold_match_score' => 'thresholdMatchScore',
        'matches_triggering_warning' => 'matchesTriggeringWarning'
    ];
    ...
    protected static $setters = [
        'threshold_match_score' => 'setThresholdMatchScore',
        'matches_triggering_warning' => 'setMatchesTriggeringWarning'
    ];
    ...
    protected static $getters = [
        'threshold_match_score' => 'getThresholdMatchScore',
        'matches_triggering_warning' => 'getMatchesTriggeringWarning'
    ];
    ...
    {
        $this->container['threshold_match_score'] = isset($data['threshold_match_score']) ? $data['threshold_match_score'] : null;
        $this->container['matches_triggering_warning'] = isset($data['matches_triggering_warning']) ? $data['matches_triggering_warning'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['threshold_match_score'] === null) {
            $invalidProperties[] = "'threshold_match_score' can't be null";
        }
        if ($this->container['matches_triggering_warning'] === null) {
            $invalidProperties[] = "'matches_triggering_warning' can't be null";
        }
    ...
    /**
     * Gets threshold_match_score
     *
     * @return float
     */
    public function getThresholdMatchScore()
    {
        return $this->container['threshold_match_score'];
    }

    /**
     * Sets threshold_match_score
     *
     * @param float $threshold_match_score threshold_match_score
     *
     * @return $this
     */
    public function setThresholdMatchScore($threshold_match_score)
    {
        $this->container['threshold_match_score'] = $threshold_match_score;

        return $this;
    }

    /**
     * Gets matches_triggering_warning
     *
     * @return float
     */
    public function getMatchesTriggeringWarning()
    {
        return $this->container['matches_triggering_warning'];
    }

    /**
     * Sets matches_triggering_warning
     *
     * @param float $matches_triggering_warning matches_triggering_warning
     *
     * @return $this
     */
    public function setMatchesTriggeringWarning($matches_triggering_warning)
    {
        $this->container['matches_triggering_warning'] = $matches_triggering_warning;
