<?php
/**
 * CallcreditIdentityCheckResponseBankruptcyOrInsolvencyTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CallcreditIdentityCheckResponseBankruptcyOrInsolvencyTest Class Doc Comment
 *
 * @category    Class
 * @description CallcreditIdentityCheckResponseBankruptcyOrInsolvency
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CallcreditIdentityCheckResponseBankruptcyOrInsolvencyTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "CallcreditIdentityCheckResponseBankruptcyOrInsolvency"
     */
    public function testCallcreditIdentityCheckResponseBankruptcyOrInsolvency()
    {
    }

    /**
     * Test attribute "bai_record_count"
     */
    public function testPropertyBaiRecordCount()
    {
    }

    /**
     * Test attribute "bai_level_of_confidence"
     */
    public function testPropertyBaiLevelOfConfidence()
    {
    }
}
