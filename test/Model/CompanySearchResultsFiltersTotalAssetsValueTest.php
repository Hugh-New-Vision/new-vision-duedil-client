<?php
/**
 * CompanySearchResultsFiltersTotalAssetsValueTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchResultsFiltersTotalAssetsValueTest Class Doc Comment
 *
 * @category    Class
 * @description Optional range of total asset values issued in the search request
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchResultsFiltersTotalAssetsValueTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "CompanySearchResultsFiltersTotalAssetsValue"
     */
    public function testCompanySearchResultsFiltersTotalAssetsValue()
    {
    }
