<?php
/**
 * CompanySearchResultsFiltersNetAssetsDeltaPercentageTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchResultsFiltersNetAssetsDeltaPercentageTest Class Doc Comment
 *
 * @category    Class
 * @description Optional range of net asset delta percentages issued in the search request
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchResultsFiltersNetAssetsDeltaPercentageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "CompanySearchResultsFiltersNetAssetsDeltaPercentage"
     */
    public function testCompanySearchResultsFiltersNetAssetsDeltaPercentage()
    {
    }
