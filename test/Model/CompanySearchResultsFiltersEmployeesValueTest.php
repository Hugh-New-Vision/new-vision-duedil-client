<?php
/**
 * CompanySearchResultsFiltersEmployeesValueTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchResultsFiltersEmployeesValueTest Class Doc Comment
 *
 * @category    Class
 * @description Optional range of employee values issued in the search request
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchResultsFiltersEmployeesValueTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "CompanySearchResultsFiltersEmployeesValue"
     */
    public function testCompanySearchResultsFiltersEmployeesValue()
    {
    }
