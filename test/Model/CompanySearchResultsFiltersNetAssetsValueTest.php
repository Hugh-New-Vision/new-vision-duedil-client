<?php
/**
 * CompanySearchResultsFiltersNetAssetsValueTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchResultsFiltersNetAssetsValueTest Class Doc Comment
 *
 * @category    Class
 * @description Optional range of net asset values issued in the search request
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchResultsFiltersNetAssetsValueTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "CompanySearchResultsFiltersNetAssetsValue"
     */
    public function testCompanySearchResultsFiltersNetAssetsValue()
    {
    }
