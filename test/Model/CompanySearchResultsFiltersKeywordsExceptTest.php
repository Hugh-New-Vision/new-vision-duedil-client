<?php
/**
 * CompanySearchResultsFiltersKeywordsExceptTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CompanySearchResultsFiltersKeywordsExceptTest Class Doc Comment
 *
 * @category    Class
 * @description Optional not included keywords issued in the search request
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CompanySearchResultsFiltersKeywordsExceptTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "CompanySearchResultsFiltersKeywordsExcept"
     */
    public function testCompanySearchResultsFiltersKeywordsExcept()
    {
    }
